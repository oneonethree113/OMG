Public Class SYM00024
    ...
    Private Sub SYM00024_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Len(strITEMNO) > 0 Then
            If isNewItemFormat(strITEMNO, True) Then
                Call Search()
            Else
                MsgBox("This item is not new format. Cannot use batch update fuction")
    ...
    Private Sub dgResult_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgResult.CellClick
        Dim iRow As Integer
