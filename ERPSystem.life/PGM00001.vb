...
Public Class PGM00001
    ...
    Dim rs_ReqInfo As DataSet
    Dim Add_flag As Boolean = False
    Dim recordstatus As Boolean = False
    Dim recordstatus_dgReqInfo As Boolean = False
    Dim flag_panpack_keypress As Boolean
    Dim rs_SYSETINF As DataSet

    Dim show_estcstflg_message As Boolean

#Region " Datagrid Variable "
    'dgReqInfo
    Dim dgReqInfo_prd_action As Integer
    Dim dgReqInfo_prd_cocde As Integer
    Dim dgReqInfo_prd_reqno As Integer
    Dim dgReqInfo_prd_seq As Integer

    Dim dgReqInfo_prd_itmall As Integer

    Dim dgReqInfo_prd_itemno As Integer
    Dim dgReqInfo_prd_assitm As Integer
    Dim dgReqInfo_prd_tmpitmno As Integer
    Dim dgReqInfo_prd_venno As Integer
    Dim dgReqInfo_prd_venitm As Integer
    Dim dgReqInfo_prd_pckunt As Integer
    Dim dgReqInfo_prd_inrqty As Integer
    Dim dgReqInfo_prd_mtrqty As Integer
    Dim dgReqInfo_prd_cft As Integer
    Dim dgReqInfo_prd_colcde As Integer
    Dim dgReqInfo_prd_sku As Integer
    Dim dgReqInfo_prd_cusitm As Integer
    Dim dgReqInfo_prd_conftr As Integer
    Dim dgReqInfo_prd_ftyprctrm As Integer
    Dim dgReqInfo_prd_hkprctrm As Integer
    Dim dgReqInfo_prd_trantrm As Integer
    Dim dgReqInfo_prd_pkgitm As Integer
    Dim dgReqInfo_prd_pkgven As Integer
    Dim dgReqInfo_prd_cate As Integer
    Dim dgReqInfo_prd_chndsc As Integer
    Dim dgReqInfo_prd_engdsc As Integer
    Dim dgReqInfo_prd_remark As Integer
    Dim dgReqInfo_prd_EInchLWH As Integer
    Dim dgReqInfo_prd_EInchL As Integer
    Dim dgReqInfo_prd_EInchW As Integer
    Dim dgReqInfo_prd_EInchH As Integer
    Dim dgReqInfo_prd_EcmLWH As Integer
    Dim dgReqInfo_prd_EcmL As Integer
    Dim dgReqInfo_prd_EcmW As Integer
    Dim dgReqInfo_prd_EcmH As Integer
    Dim dgReqInfo_prd_FInchLWH As Integer
    Dim dgReqInfo_prd_FInchL As Integer
    Dim dgReqInfo_prd_FinchW As Integer
    Dim dgReqInfo_prd_FinchH As Integer
    Dim dgReqInfo_prd_FcmLWH As Integer
    Dim dgReqInfo_prd_FcmL As Integer
    Dim dgReqInfo_prd_FcmW As Integer
    Dim dgReqInfo_prd_FcmH As Integer
    Dim dgReqInfo_prd_matral As Integer
    Dim dgReqInfo_prd_matDsc As Integer
    Dim dgReqInfo_prd_tiknes As Integer
    Dim dgReqInfo_prd_tikDsc As Integer
    Dim dgReqInfo_prd_prtmtd As Integer
    Dim dgReqInfo_prd_prtDsc As Integer
    Dim dgReqInfo_prd_clrfot As Integer
    Dim dgReqInfo_prd_clrbck As Integer
    Dim dgReqInfo_prd_finish As Integer
    Dim dgReqInfo_prd_rmtnce As Integer
    Dim dgReqInfo_prd_addres As Integer
    Dim dgReqInfo_prd_state As Integer
    Dim dgReqInfo_prd_cntry As Integer
    Dim dgReqInfo_prd_zip As Integer
    Dim dgReqInfo_prd_Tel As Integer
    Dim dgReqInfo_prd_cntper As Integer
    Dim dgReqInfo_prd_sctoqty As Integer
    Dim dgReqInfo_prd_qtyum As Integer
    Dim dgReqInfo_prd_curcde As Integer
    Dim dgReqInfo_prd_multip As Integer
    Dim dgReqInfo_prd_ordqty As Integer
    Dim dgReqInfo_prd_wasper As Integer
    Dim dgReqInfo_prd_wasqty As Integer
    Dim dgReqInfo_prd_bonqty As Integer
    Dim dgReqInfo_prd_ttlordqty As Integer
    Dim dgReqInfo_prd_untprc As Integer
    Dim dgReqInfo_prd_ttlamtqty As Integer
    Dim dgReqInfo_prd_receqty As Integer
    Dim dgReqInfo_prd_ordno As Integer
    Dim dgReqInfo_prd_ordseq As Integer
    Dim dgReqInfo_prd_flag As Integer
    Dim dgReqInfo_prd_salprc As Integer
    Dim dgReqInfo_prd_ScToNo As Integer
    Dim dgReqInfo_prd_ScToSeq As Integer
    Dim dgReqInfo_prd_creusr As Integer
    Dim dgReqInfo_prd_updusr As Integer
    Dim dgReqInfo_prd_credat As Integer
    Dim dgReqInfo_prd_upddat As Integer
    Dim dgReqInfo_prd_timstp As Integer
#End Region
    ...
    Private Sub resetcmdButton(ByVal Mode As String)
        If Mode = "INIT" Then
            ...
            cmdReqInfoUpdate.Enabled = False
            PanReqInfoUpdate.Visible = False
            show_estcstflg_message = False
    ...
    Private Sub resetdisplay(ByVal mode As String)
        ...
        ElseIf mode = "UPDATE" Then
            ...
            chkEstCstFlg.Enabled = True

            cmdReqInfoUpdate.Enabled = True
    ...
    End Sub
    Public Sub mmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdAdd.Click
    ...
    Private Sub display()
        ...
        If rs_PKIMBAIF.Tables("RESULT").Rows(0).Item("pib_estflg") = "Y" Then
            chkEstCstFlg.Checked = True
        Else
            chkEstCstFlg.Checked = False
        End If
    ...
    Private Function Save_PKIMBAIF() As Boolean
        ...
        If chkEstCstFlg.Checked = True Then
            pib_estflg = "Y"
        Else
            pib_estflg = "N"
        End If
        ...
        If Add_flag = True Then  '''''''''''''''''''''Copy flag
            ...
            gspStr = "sp_insert_PKIMBAIF '" & pib_pgitmno & "','" & pib_cate & "','" & pib_year & "','" & pib_status & "','" & _
                  ...
                  ",'" & pib_cus1no & "','" & pib_cus2no & "','" & pib_matral & "','" & pib_tiknes & "','" & pib_prtmtd & _
                   ...
                   pib_img & "','" & pib_season & "','" & pib_estflg & "','" & gsUsrID & "'"
    ...
    Private Sub cmdReqInfoUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReqInfoUpdate.Click
        If recordstatus = True Then
            MsgBox("Item in edit mode, Please save record for request information update")
            Exit Sub
        End If

        resetdisplay("ReadOnly")

        PanReqInfoUpdate.Visible = True
        PanReqInfoUpdate.Top = 80
        PanReqInfoUpdate.Left = 48

        PanReqInfoUpdate.Width = 646
        PanReqInfoUpdate.Height = 262


        gspStr = "sp_list_PKREQDTL_by_item '', '" & txtPKITMNO.Text & "'"

        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        rtnLong = execute_SQLStatement(gspStr, rs_ReqInfo, rtnStr)
        Me.Cursor = Windows.Forms.Cursors.Default
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading cmdReqInfoUpdate sp_list_PKREQDTL_by_item : " & rtnStr)
        Else
            If rs_ReqInfo.Tables("RESULT").Rows.Count = 0 Then
                MsgBox("No corresponding Packaging Request found!")
                Exit Sub
            Else
                recordstatus_dgReqInfo = False
                Call display_dgReqInfo()
            End If
        End If
    ...
    Private Sub cmdReqInfoCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReqInfoCancel.Click
        PanReqInfoUpdate.Visible = False
        resetdisplay(mode)
    End Sub
    ...
    Private Sub display_dgReqInfo()
        If rs_ReqInfo.Tables.Count = 0 Then
            Exit Sub
        End If

        dgReqInfo.RowHeadersWidth = 18
        dgReqInfo.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing
        dgReqInfo.ColumnHeadersHeight = 18
        dgReqInfo.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing
        dgReqInfo.AllowUserToResizeColumns = True
        dgReqInfo.AllowUserToResizeRows = False
        dgReqInfo.RowTemplate.Height = 18

        rs_ReqInfo.Tables("RESULT").Columns(0).ReadOnly = False


        dgReqInfo.DataSource = rs_ReqInfo.Tables("RESULT").DefaultView

        Dim i As Integer

        i = 0
        dgReqInfo_prd_action = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Upd"
        dgReqInfo.Columns(i).ReadOnly = True
        dgReqInfo.Columns(i).Width = 30
        i = i + 1
        dgReqInfo_prd_cocde = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Comp"
        dgReqInfo.Columns(i).Width = 30
        i = i + 1
        dgReqInfo_prd_reqno = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Req No"
        dgReqInfo.Columns(i).Width = 80
        i = i + 1
        dgReqInfo_prd_seq = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Seq"
        dgReqInfo.Columns(i).Width = 30
        i = i + 1
        dgReqInfo_prd_itemno = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Item/Ast/Temp/Vdr/VdrItm"
        dgReqInfo.Columns(i).Width = 150
        i = i + 1
        dgReqInfo_prd_itemno = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_assitm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_tmpitmno = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_venno = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_venitm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_pckunt = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_inrqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_mtrqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_cft = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_colcde = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_sku = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_cusitm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_conftr = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ftyprctrm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_hkprctrm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_trantrm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_pkgitm = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_pkgven = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_cate = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_chndsc = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Chn Dsc"
        dgReqInfo.Columns(i).Width = 80
        i = i + 1
        dgReqInfo_prd_engdsc = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_remark = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "Remark"
        dgReqInfo.Columns(i).Width = 80
        i = i + 1
        dgReqInfo_prd_EInchLWH = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "EInchLWH"
        dgReqInfo.Columns(i).Width = 130
        i = i + 1
        dgReqInfo_prd_EInchL = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_EInchW = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_EInchH = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_EcmLWH = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "EcmLWH"
        dgReqInfo.Columns(i).Width = 130
        i = i + 1
        dgReqInfo_prd_EcmL = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_EcmW = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_EcmH = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FInchLWH = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "FInchLWH"
        dgReqInfo.Columns(i).Width = 130
        i = i + 1
        dgReqInfo_prd_FInchL = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FinchW = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FinchH = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FcmLWH = i
        dgReqInfo.Columns(i).Visible = True
        dgReqInfo.Columns(i).HeaderText = "FcmLWH"
        dgReqInfo.Columns(i).Width = 130
        i = i + 1
        dgReqInfo_prd_FcmL = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FcmW = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_FcmH = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_matral = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_matDsc = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_tiknes = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_tikDsc = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_prtmtd = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_prtDsc = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_clrfot = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_clrbck = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_finish = i
        dgReqInfo.Columns(i).Visible = True
        i = i + 1
        dgReqInfo_prd_rmtnce = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_addres = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_state = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_cntry = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_zip = i
        dgReqInfo.Columns(i).Visible = False
        ...
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_cntper = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_sctoqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_qtyum = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_curcde = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_multip = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ordqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_wasper = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_wasqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_bonqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ttlordqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_untprc = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ttlamtqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_receqty = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ordno = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ordseq = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_flag = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_salprc = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ScToNo = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_ScToSeq = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_creusr = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_updusr = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_credat = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_upddat = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
        dgReqInfo_prd_timstp = i
        dgReqInfo.Columns(i).Visible = False
        i = i + 1
    End Sub

    Private Sub dgReqInfo_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgReqInfo.CellClick
        If dgReqInfo.RowCount > 0 Then
            Dim iCol As Integer = dgReqInfo.CurrentCell.ColumnIndex
            Dim iRow As Integer = dgReqInfo.CurrentCell.RowIndex
            Dim curvalue As String
            curvalue = dgReqInfo.CurrentCell.Value

            Dim i As Integer

            If dgReqInfo.CurrentCell.ColumnIndex = dgReqInfo_prd_action Then
                If curvalue = "Y" Then
                    dgReqInfo.Item(dgReqInfo_prd_action, iRow).Value = "N"
                Else
                    dgReqInfo.Item(dgReqInfo_prd_action, iRow).Value = "Y"
                End If
                recordstatus_dgReqInfo = True
            End If
        End If
    End Sub


    Private Sub dgReqInfo_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgReqInfo.CellContentClick

    End Sub

    Private Sub dgReqInfo_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgReqInfo.CellDoubleClick
        If dgReqInfo.RowCount > 0 Then
            Dim iCol As Integer = dgReqInfo.CurrentCell.ColumnIndex
            Dim iRow As Integer = dgReqInfo.CurrentCell.RowIndex
            Dim curvalue As String
    ...
    Private Sub cmdReqInfoSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReqInfoSelect.Click
        Dim i As Integer
        Dim curvalue As String

        For i = 0 To dgReqInfo.RowCount - 1
            If dgReqInfo.Rows(i).Selected = True Then
                curvalue = dgReqInfo.Item(dgReqInfo_prd_action, i).Value

                If curvalue = "N" Then
                    dgReqInfo.Item(dgReqInfo_prd_action, i).Value = "Y"
                End If
                recordstatus_dgReqInfo = True
            End If
        Next i
    ...
    Private Sub cmdReqInfoOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReqInfoOK.Click
        Dim i As Integer
        Dim curvalue As String
        Dim cocde As String
        Dim reqno As String
        Dim reqseq As String

        If MsgBox("Confirm update selected request detail?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            For i = 0 To dgReqInfo.RowCount - 1
                curvalue = dgReqInfo.Item(dgReqInfo_prd_action, i).Value

                If curvalue = "Y" Then
                    cocde = dgReqInfo.Item(dgReqInfo_prd_cocde, i).Value
                    reqno = dgReqInfo.Item(dgReqInfo_prd_reqno, i).Value
                    reqseq = dgReqInfo.Item(dgReqInfo_prd_seq, i).Value

                    gspStr = "sp_update_PKREQDTL_pkgdsc '" & cocde & "', '" & reqno & "'," & reqseq & ",'" & gsUsrID & "'"

                    Me.Cursor = Windows.Forms.Cursors.WaitCursor
                    rtnLong = execute_SQLStatement(gspStr, rs, rtnStr)
                    Me.Cursor = Windows.Forms.Cursors.Default
                    If rtnLong <> RC_SUCCESS Then
                        MsgBox("Error on loading cmdReqInfoOK_Click sp_update_PKREQDTL_pkgdsc : " & rtnStr)
                        Exit Sub
                    End If
                End If
            Next i
            MsgBox("Update Completed")
            Call cmdReqInfoUpdate_Click(sender, e)
            Exit Sub
        End If
    End Sub

    Private Sub chkEstCstFlg_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkEstCstFlg.CheckedChanged
        If chkEstCstFlg.Checked = False And show_estcstflg_message = True Then
            If MsgBox("Are you sure to uncheck the estimated cost flag?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
                chkEstCstFlg.Checked = True
            End If
        End If
    End Sub
...
#Region "Movable Panel"
    ...
    Private Sub panelMoveTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Select Case movePanel
            Case PanReqInfoUpdate.Name
                SetPanelPosition(PanReqInfoUpdate)
        End Select


    End Sub

    Private Sub PanReqInfoUpdate_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles panhead1.MouseDown, Label33.MouseDown
        movePanel = PanReqInfoUpdate.Name
        panelMoveTimer.Enabled = True
        panelMoveTimer.Start()
        RenewPanel(PanReqInfoUpdate)
    End Sub

    Private Sub PanReqInfoUpdate_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles panhead1.MouseUp, Label33.MouseUp
        panelMoveTimer.Stop()
        RenewPanel(PanReqInfoUpdate)
        movePanel = ""
    End Sub
#End Region
    ...
    Private Sub StatusBar_ItemClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs)
