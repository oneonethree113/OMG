...
Public Class IMG00001
    ...
    Private Sub cmdCopyMove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCopyMove.Click
        ...
        strLocSrcFolder = BaseName(filSourcePath, "\")
        ...
        For i As Integer = 0 To filSource.Items.Count - 1
            If filSource.SelectedIndices.Contains(i) Then
                ...
                If subDir <> expItem Then
                    '                    destpth = Replace(filSourcePath, "\Upload", "\Uploaded") + "\" + strLocDesFolder
                ...
                If confirm = MsgBoxResult.Yes Then
                    ...
                    defaultSourceUploaded = Replace(filSourcePath, "\Upload", "\UPLOADED")
                    '20160229
                    If found = True Then
...
FILE_ACCESS_ERROR:
    ...
    Private Sub optUploadImgFolder_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optUploadImgFolder.CheckedChanged
