...
Public Class INR00001B1Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.INR00001B1Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Pm_INR00001Bhid_untsel() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Pm_total_amt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedINR00001B1Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INR00001B1Rpt = New INR00001B1Rpt
        rpt.Site = Me.Site
        Return rpt
    End Function
