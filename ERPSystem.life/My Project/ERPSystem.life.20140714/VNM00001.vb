...
Public Class VNM00001
    ...
    Private Sub resetdisplay(ByVal mode As String)
        ...
        ElseIf mode = "ReadOnly" Then
            ...
            txtChnAdr.Enabled = True
            txtChnAdr.ReadOnly = True
    ...
    Private Sub display()
        ...
        'tap2
        txtAdr.Text = rs_VNCNTINF_M_READ.Tables("RESULT").Rows(0).Item("vci_adr")
        txtChnAdr.Text = rs_VNCNTINF_M_READ.Tables("RESULT").Rows(0).Item("vci_chnadr")
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        If cboVenType.Text = "" Then
            MsgBox("Please select the Vendor Type first!")
            txtVenNo.Text = ""
            txtVenNo.Enabled = False
    ...
    Private Sub add_VNCNTPER()
        ...
        If dr.Length = 0 Then
            ...
            rs_VNCNTPER_READ.Tables("RESULT").Rows(rowcount).Item("vci_cntdef") = "N"
    ...
    Private Sub add_VNCNTINF()
        ...
        If dr.Length = 0 Then
            ...
            rs_VNCNTINF_U_READ.Tables("RESULT").Rows(rowcount).Item("vci_cty") = "CN - CHINA"
    ...
    Private Sub grdVnCntPer_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdVnCntPer.CellContentClick
    ...
    Private Function save_VNCUGREL() As Boolean
        ...
        For i = 0 To rs_VNCUGREL_READ.Tables("RESULT").Rows.Count - 1
            ...
            If vcr_creusr = "~*ADD*~" Then
                gspStr = "sp_insert_VNCUGREL '','" & vcr_venno & "','" & vcr_cugrpcde & "','" & vcr_flg_int & "','" & vcr_flg_ext & "','" & gsUsrID & "'"
                rtnLong = execute_SQLStatement(gspStr, rs, rtnStr)
                If rtnLong <> RC_SUCCESS Then
    ...
    Private Function save_VNBASINF() As Boolean   '''''''''''''''''''''''''finish it!!!!!'''''''''''''''
        ...
        vci_chnadr = Replace(txtChnAdr.Text, "'", "''")
        ...
        For i = 0 To rs_VNCNTPER_READ.Tables("RESULT").Rows.Count - 1
            ...
            ElseIf vci_updusr = "~*ADD*~" Then
                If vci_cntctp <> "" Then
                   ...
                   vci_stt & "','" & vci_cty & "','" & vci_zip & "','" & vci_cntctp & "','" & vci_cnttil & "','" & vci_cntphn & "','" & _
    ...
    Private Function save_VnCntInf() As Boolean '' rs_VNCNTINF_U_READ
        ...
        For i = 0 To rs_VNCNTINF_U_READ.Tables("RESULT").Rows.Count - 1
            ...
            If vci_cocde = "Y" Then
                gspStr = "sp_physical_delete_VNCNTINF '','" & vci_venno & "','U'," & vci_seq
                rtnLong = execute_SQLStatement(gspStr, rs, rtnStr)
                If rtnLong <> RC_SUCCESS Then
    ...
    Private Function check_Vendor() As Boolean
        ...
        If Trim(txtAdr.Text) = "" And Trim(txtChnAdr.Text) = "" Then
    ...
    Private Sub grdVnCntPer_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdVnCntPer.CellEndEdit
    ...
    Private Sub txtChnAdr_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtChnAdr.KeyPress
        If mode = "UPDATE" Then
            Recordstatus = True
        End If
    End Sub

    Private Sub txtChnAdr_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtChnAdr.KeyUp
        If mode = "UPDATE" Then
            Recordstatus = True
        End If
    End Sub
    ...
    Private Sub txtChnAdr_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtChnAdr.LostFocus
        txtChnAdr.Text = UCase(txtChnAdr.Text)
    End Sub

    Private Sub txtChnAdr_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtChnAdr.TextChanged
