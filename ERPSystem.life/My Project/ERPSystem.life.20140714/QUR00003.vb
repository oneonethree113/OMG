        ...
        Try
            ...
            With xlsApp
                For i As Integer = 0 To rs_QUR0000excel.Tables("RESULT").DefaultView.Count - 1
                    ...
                    .Range("BF" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_ftyshpstr")
                    .Range("BG" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_ftyshpend")

                    '''special handle
                    If DateDiff("d", .Range("BF" + (i + 3).ToString).Value, "01/01/1900") = 0 Then
                        '.Range("BF" + (i + 3).ToString).Value = "01/01/1900"
                        .Range("BF" + (i + 3).ToString).Value = ""
                    End If
                    ...
                    End If
                    If DateDiff("d", .Range("BF" + (i + 3).ToString).Value, "11/19/2000") = 0 Then
                        '.Range("BF" + (i + 3).ToString).Value = "01/01/1900"
                        .Range("BF" + (i + 3).ToString).Value = ""
                    End If
                    If DateDiff("d", .Range("BG" + (i + 3).ToString).Value, "11/19/2000") = 0 Then
                        ...
                        .Range("BG" + (i + 3).ToString).Value = ""
                    End If
                    If DateDiff("d", .Range("BF" + (i + 3).ToString).Value, "11/19/00") = 0 Then
                        '.Range("BF" + (i + 3).ToString).Value = "01/01/1900"
                        .Range("BF" + (i + 3).ToString).Value = ""
                    End If
                    ...
                    '''20140224
                    .Range("BH" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_cushpstr")
                    .Range("BI" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_cushpend")
                    ...
                    If IsNumeric(rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_toqty")) Then
                        .Range("BJ" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_toqty")
                    Else
                        .Range("BJ" + (i + 3).ToString).Value = "0"
                    End If

                    .Range("BK" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_toshipport")
                    .Range("BL" + (i + 3).ToString).Value = rs_QUR0000excel.Tables("RESULT").DefaultView(i)("qud_tormk")
