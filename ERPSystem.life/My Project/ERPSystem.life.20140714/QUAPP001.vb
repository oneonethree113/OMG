...
Public Class QUAPP001
    ...
    'Private Sub cmdOK_Click_old(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
    ...
    '              "','" & temp_insert_cus1no & _
    '              "','" & temp_insert_cus2no & _
    ...
    '              "','" & Replace(.Range("N" + (i + 3).ToString).Value, "'", "''") & _
    '              "','" & "" & _
    ...
    '              "','" & temp_value_AM & _
    '              "','" & temp_value_AN & _
    '              "','" & IIf(IsNumeric(.Range("AO" + (i + 3).ToString).Value) And UCase(.Range("AO" + (i + 3).ToString).Value) <> "FALSE", .Range("AO" + (i + 3).ToString).Value, "0") & _
    ...
    '    gspStr = "sp_select_QUAPP001 '" & cboCoCde.Text.Trim & _
    '               "','" & txtQutNo.Text.Trim & _
    '                "','" & FileToCopy & _
    '                 "','" & tmp_date & "'"
    ...
    '    If rtnLong <> RC_SUCCESS Then
    '        MsgBox("Error on loading sp_select_QUAPP001 :" & rtnStr)
    '        Exit Sub
    '    End If
    ...
    '    '        If Trim(.Range("S" + (i + 2).ToString).Value()) <> "1" And Trim(.Range("S" + (i + 2).ToString).Value()) <> "" Then
    '    '            temp_qud_itmtyp = "ASS"
    '    '            temp_qud_contopc = "Y"
    '    '        Else
    '    '            temp_qud_itmtyp = "REG"
    ...
    '    '        '.Range("L" + (i + 2).ToString).Value = "A"
    '    '        gspStr = "sp_insert_QUPRCEMT_from_excel '" & Me.cboCoCde.Text & "','" & Me.txtQutNo.Text & "','" & "1" & _
    '    '          "','" & .Range("L" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("O" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AP" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AS" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AT" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AU" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AV" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AW" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("AZ" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("BA" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("BD" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("A" + (i + 2).ToString).Value & _
    '    '          "','" & .Range("N" + (i + 2).ToString).Value & _
    '    '         "','" & temp_qud_itmtyp & _
    '    '           "','" & gsUsrID & "'"
...
exit_main_loop:
    ...
    Private Sub tpQUXLS001_1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tpQUXLS001_1.Click
