...
Public Class PKR00001B1Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.PKR00001B1Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPKR00001B1Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PKR00001B1Rpt = New PKR00001B1Rpt
        rpt.Site = Me.Site
        Return rpt
    End Function
