...
Public Class IMR00004

    Dim rs_IMR00004 As DataSet

    Private Sub IMR0004_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Formstartup(Me.Name)
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        gspStr = "sp_list_IMR00004 '','" & txtRecSts & "','" & Trim(txtFromVenNc.Text) & "','" & _
                 Trim(txtToVenNc.Text) & "','" & fromdate & "','" & todate & "','" & incBOM & "','" & gsUsrID & "'"

        Me.Cursor = Windows.Forms.Cursors.WaitCursor

        rtnLong = execute_SQLStatement(gspStr, rs_IMR00004, rtnStr)
        ''''''''''
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading IMR00004 #001 sp_list_IMR00004 : " & rtnStr)
            Exit Sub
        End If
        If rs_IMR00004.Tables("RESULT").Rows.Count = 0 Then
            MsgBox("No Record Found!", MsgBoxStyle.Information, "Information")
        Else
            rs_IMR00004.Tables("RESULT").Columns(13).ColumnName = "@stage"
            rs_IMR00004.Tables("RESULT").Columns(14).ColumnName = "@fromvenno"
            rs_IMR00004.Tables("RESULT").Columns(15).ColumnName = "@tovenno"
            rs_IMR00004.Tables("RESULT").Columns(16).ColumnName = "@fromcredat"
            rs_IMR00004.Tables("RESULT").Columns(17).ColumnName = "@tocredat"

            Dim objRpt As New IMR00004Rpt
            objRpt.SetDataSource(rs_IMR00004.Tables("RESULT"))
    ...
    Private Sub cmdExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExcel.Click
        ...
        gspStr = "sp_list_IMR00004_xls '','" & txtRecSts & "','" & Trim(txtFromVenNc.Text) & "','" & _
                 Trim(txtToVenNc.Text) & "','" & Format(dtpFromTrand.Value, "yyyy-MM-dd").ToString.Substring(0, 10) & "','" & _
                 Format(dtpToTrand.Value, "yyyy-MM-dd").ToString.Substring(0, 10) & "','" & incBOM & "','" & gsUsrID & "'"
        ...
        Dim rs_ds As New DataSet
        rtnLong = execute_SQLStatement(gspStr, rs_ds, rtnStr)

        Me.Cursor = Windows.Forms.Cursors.Default

        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading IMR00004 #002 sp_list_IMR00004_xls : " & rtnStr)
            Exit Sub
        End If
    ...
    Private Sub ExportToExcel(ByVal rs_EXCEL As ADODB.Recordset)
        ...
        xlsApp.Cells(1, 2) = "D. Ven"
        xlsApp.Cells(1, 3) = "P. Ven"
        xlsApp.Cells(1, 4) = "Date"
        xlsApp.Cells(1, 5) = "Item No."
