...
Public Class PGM00007
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        If Combo1.SelectedIndex = 0 Then
            gspStr = "sp_select_abc '" & gsCompany & "','" & txt_S_PKGNo.Text & "'"
            message = "SP_SELECT_PGM00007_EXCEL"
            rtnLong = execute_SQLStatement(gspStr, rs_PGMExcel, rtnStr)
        Else
            gspStr = "sp_select_abc_excel '" & gsCompany & "','" & txt_S_PKGNo.Text & "'"
            message = "SP_SELECT_PGM00007_EXCEL"
        ...
        If rs_PGMExcel.Tables("RESULT").Rows.Count = 0 Then
            ...
            gspStr = "sp_select_abc_check '" & gsCompany & "','" & txt_S_PKGNo.Text & "'"
    ...
    Private Sub txt_S_PKGNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_S_PKGNo.TextChanged
