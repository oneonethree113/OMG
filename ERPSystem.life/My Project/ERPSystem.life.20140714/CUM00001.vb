Public Class CUM00001
    ...
    Private Sub setStatus(ByVal Mode As String)
        ...
        ElseIf Mode = "Updating" Then
            ...
            cmdDelete.Enabled = Del_right_local 'True
            'CmdDelete.Enabled = True
            cmdCopy.Enabled = Enq_right_local 'True
            ...
            cmdDelRow.Enabled = Enq_right_local 'True 'Del_right_local
            cmdExit.Enabled = True
            cmdClear.Enabled = True
    ...
    Private Sub Display()
        ...
        Me.StatusBar.Items("lblRight").Text = Convert.ToDateTime(rs_CUBASINF.Tables("RESULT").Rows(0).Item("cbi_credat")).ToString("dd/MM/yyyy") & " " _
        & Convert.ToDateTime(rs_CUBASINF.Tables("RESULT").Rows(0).Item("cbi_upddat")).ToString("dd/MM/yyyy") _
    ...
    Private Sub checkrightCucalfml()
        ...
        If gsUsrGrp = "CED-S" Or gsUsrGrp = "CED-R" Or gsUsrGrp = "CED-G" Or gsUsrGrp = "CED-G2" Or gsUsrGrp = "MIS-S" Then
    ...
    Private Sub SetGrdContact()
        ...
        grdContact.Columns(i).Width = 100
        grdContact.Columns(i).ReadOnly = False
        i = i + 1
    ...
    Private Sub Setgrdshipping()
        ...
        grdShipping.Columns(i).Width = 300
    ...
    Private Sub SetGrdBilling()
        ...
        grdBilling.Columns(i).Width = 300
    ...
    Private Sub cmdClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClear.Click
        ...
        If Recordstatus = True And Trim(txtCusno.Text) = "" And cmdSave.Enabled = True Then
            ...
            End If
        ElseIf (Recordstatus = True Or FRecordstatus = True) And txtCusno.Text <> "" And cmdSave.Enabled = True Then
    ...
    Private Function save_CUBASINF() As Boolean
        ...
        Else
            ...
            gspStr = "sp_update_CUBASINF '" & cbi_cocde & "','" & cbi_cusno & "','" & cbi_custyp & "','" & cbi_cussts & "','" & _
                 ...
                 cbi_cusrat & "','" & cbi_mrkreg & "','" & cbi_mrktyp & "','" & cbi_advord & "','" & cbi_rmk & "','" & cbi_cuspod & _
                 "','" & cbi_cusfde & "','" & cbi_cuscfs & "','" & cbi_custhc & "','" & cbi_cuspro & "','" & cbi_cerdoc & _
                  "','" & cbi_cusali & "','" & cbi_cugrptyp_int & "','" & cbi_cugrptyp_ext & "'," & cbi_roudning & ",'" & cbi_updusr & "'"
...
grdItmCatMarkup.Item(grdItmCatMarkup_ocm_creusr, iRow).Value <> "~*NEW*~" Then
    ...
    Private Sub txtShpMrk1_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtShpMrk1.LostFocus
        ...
        If MultiLineTextIsValid(txtShpMrk1.Text, 40) = False Then
            ...
            txtShpMrk4.Top = 220
            txtShpMrk4.Left = 158
            txtShpMrk4.Width = 357
            txtShpMrk4.Height = 50
    ...
    Private Sub txtShpMrk4_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtShpMrk4.LostFocus
        txtShpMrk4.Height = 50
        txtShpMrk4.Top = 220 'txtShpMrk4.Top + 42
    End Sub
    ...
    Private Sub grdPrctrm_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdPrctrm.CellContentClick
