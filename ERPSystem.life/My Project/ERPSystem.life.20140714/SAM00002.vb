Public Class SAM00002
    ...
    Private Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        'S = "㊣SAORDSUM※S※" & txtCusNo.Text & "※" & txtItmNo.Text & "※" & txtColCde.Text & "※" & txtUpdDat.Text & "※" & gsUsrID & _
        '    "㊣SAORDDTL※S※" & txtCusNo.Text & "※" & txtItmNo.Text & "※" & txtColCde.Text & "※" & txtUpdDat.Text & "※" & gsUsrID & "※" & gsFlgCst & "※" & gsFlgCstExt
...
result:
    ...
    Private Sub Display_Sum()
        ...
        With grdSum
            ...
            .Columns(4).Width = 80
            .Columns(4).HeaderCell.Value = "Final Item #"

            '.Columns(5).width = 1000
            .Columns(5).Width = 60
            .Columns(5).HeaderCell.Value = "VD. Color Code"
            ...
            '.Columns(8).width = 900
            .Columns(8).Width = 40
            .Columns(8).HeaderCell.Value = "Total Sample Qty"
            ...
            '.Columns(21).Width = 0
            .Columns(21).HeaderCell.Value = "Temp Item #"
            .Columns(21).DisplayIndex = 5
            .Columns(21).Width = 80
            .Columns(22).HeaderCell.Value = "Vendor Item #"
    ...
    Private Sub Display_Dtl()
        ...
        With grdDtl
            ...
            .Columns(9).Width = 80
            .Columns(9).HeaderCell.Value = "Original Item #"

            '.Columns(10).width = 1300
            .Columns(10).Width = 80
            .Columns(10).HeaderCell.Value = "Final Item #"

            '.Columns(11).width = 1000
            .Columns(11).Width = 60
            .Columns(11).HeaderCell.Value = "VD. Color Code"
            ...
            .Columns(14).Width = 40
            .Columns(14).HeaderCell.Value = "Sample U/M"

            '.Columns(15).width = 900
            .Columns(15).Width = 40
            .Columns(15).HeaderCell.Value = "Sample Stock Qty"

            '.Columns(16).width = 900
            .Columns(16).Width = 40
            .Columns(16).HeaderCell.Value = "Cust Sample Qty"

            '.Columns(17).width = 900
            .Columns(17).Width = 40
            .Columns(17).HeaderCell.Value = "Total Sample Qty"

            '.Columns(18).width = 500
            .Columns(18).Width = 40
            .Columns(18).HeaderCell.Value = "CCY"

            '.Columns(19).width = 1000
            .Columns(19).Width = 50
            .Columns(19).HeaderCell.Value = "Sample Selling Price"
            ...
            .Columns(24).Width = 80
            .Columns(24).HeaderCell.Value = "Customer Item #"
            ...
            .Columns(27).Width = 60
            .Columns(27).HeaderCell.Value = "Vendor Code"
            ...
            .Columns(29).Width = 60
            .Columns(29).HeaderCell.Value = "C. Vendor"
            ...
            .Columns(32).Width = 80
            .Columns(32).HeaderCell.Value = "Sample Request #"
            ...
            .Columns(43).HeaderCell.Value = "Temp Item #"
            .Columns(43).DisplayIndex = 11
            .Columns(43).Width = 80
            .Columns(44).HeaderCell.Value = "Vendor Item #"
