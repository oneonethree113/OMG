Public Class SAM00003
    ...
    Private Sub SAM00003_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'End If
        lblFtyPrc.Text = "Sample Total Cost"
    ...
    Private Sub setStatus(ByVal Mode As String)
        ...
        If Mode = "Init" Then
            ...
            cmdAdd.Enabled = Enq_right_local 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
        ...
        ElseIf Mode = "ADD" Then
            ...
            cmdDelRow.Enabled = True 'Del_right_local 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
        ...
        ElseIf Mode = "Updating" Then
            ...
            If Split(cboInvSts.Text, " - ")(0) = "REL" Or Split(cboInvSts.Text, " - ")(0) = "CLO" Then 'Or Split(cboInvSts.Text, " - ")(0) = "HLD"
                cmdAdd.Enabled = False
                cmdSave.Enabled = False 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
                cmdDelete.Enabled = False 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
                cmdCopy.Enabled = False 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
                cmdFind.Enabled = False
                cmdSearch.Enabled = False
                cmdInsRow.Enabled = False 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
                cmdDelRow.Enabled = False 'True '*** For Access Right use, added by Tommy on 5 Oct 2001
                cmdExit.Enabled = True
                cmdClear.Enabled = True
    ...
    Private Sub SetStatusBar(ByVal Mode As String)
        ...
        ElseIf Mode = "Updating" And cmdSave.Enabled = True Then
        ...
        ElseIf Mode = "ReadOnly" Or cmdSave.Enabled = False Then
    ...
    Private Sub Display_Summary()
        ...
        With grdSummary
            ...
            .Columns(14).Width = 60
            .Columns(14).HeaderCell.Value = "Cust SA PO"
            ...
            .Columns(18).Width = 60
            .Columns(18).HeaderCell.Value = "SA SelPrc U/M"
            ...
            .Columns(19).Width = 60
            .Columns(19).HeaderCell.Value = "Ttl Amt/Item"
            ...
            .Columns(20).Width = 60
            .Columns(20).HeaderCell.Value = "SA U/M"
            ...
            .Columns(22).Width = 60
            .Columns(22).HeaderCell.Value = "Ship FreeQty"
            ...
            .Columns(55).HeaderCell.Value = "Venno Item#"
            ...
            .Columns(56).HeaderCell.Value = "Venno #"
        ...
        If Recordstatus Then
            ...
            Select Case MsgBox(save_msg, MsgBoxStyle.YesNoCancel)
                Case MsgBoxResult.Yes
                    If cmdSave.Enabled = True And InputSampleDetailIsValid() Then
    ...
    Private Sub cboCus1Ad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCus1Ad.Click
        'MsgBox("there")
        ...
        Else
            ...
            Else
                For i As Integer = 0 To rs_CUCNTINF_Adr.Tables("RESULT").Rows.Count - 1
                    cboCus1Ad.Items.Add(Trim(rs_CUCNTINF_Adr.Tables("RESULT").Rows(0).Item("cci_cntadr")))
                Next
            End If
        End If
...
chkApprove.Checked & "','" & gsUsrID & "'"
    ...
    Private Sub cboCus1Ad_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCus1Ad.SelectedIndexChanged
