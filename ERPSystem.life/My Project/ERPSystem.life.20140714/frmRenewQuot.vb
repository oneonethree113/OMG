Public Class frmRenewQuot
    ...
    Private Sub frmRenewQuot_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'flgRecFound = False
        'lstNewItem.Visible = False
        'Me.lstNewPck.Visible = False
        ...
        If InStr(cus2no, "-") > 0 Then
            cus2no = Trim(Split(cus2no, "-")(0))
        End If
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading frmRenewQuot_Load sp_select_CUBASINF_PC :" & rtnStr)
            Exit Sub
        End If

        If Len(Quotno) > 0 Then
            Call showOldItemQuot()
        End If
    ...
    Private Sub showOldItemQuot()
        ...
        'S = "㊣QUOTNDTL_olditm※L※" & Quotno & "※DTL㊣QUOTNDTL_olditm※L※" & Quotno & "※LST"
        ...
        gspStr = "sp_list_QUOTNDTL_olditm '" & ma.cboCoCde.Text & "','" & Quotno & "','DTL'"
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading showOldItemQuot sp_list_QUOTNDTL_olditm DTL :" & rtnStr)
            Cursor = Cursors.Default
            Exit Sub
        End If
        ...
        gspStr = "sp_list_QUOTNDTL_olditm '" & ma.cboCoCde.Text & "','" & Quotno & "','LST'"
        rtnLong = execute_SQLStatement(gspStr, rs_List, rtnStr)
        gspStr = ""

        Cursor = Cursors.Default

        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading showOldItemQuot sp_list_QUOTNDTL_olditm LST :" & rtnStr)
            Cursor = Cursors.Default
            Exit Sub
        End If

        If rs_List.Tables("RESULT").Rows.Count = 0 Then
            MsgBox("No Record Found!")
            Cursor = Cursors.Default
            Exit Sub
        End If
        ...
        If rs_Result.Tables("RESULT").DefaultView.Count > 0 Then
            ...
            With rs_Result
                For index As Integer = 0 To .Tables("RESULT").DefaultView.Count - 1
                    sFilter = "qud_qutseq = '" & .Tables("RESULT").DefaultView(index)("qud_qutseq").ToString & "'"
                    ma.rs_QUOTNDTL.Tables("RESULT").DefaultView.RowFilter = sFilter

                    If ma.rs_QUOTNDTL.Tables("RESULT").DefaultView.Count > 0 Then
                        If ma.rs_QUOTNDTL.Tables("RESULT").DefaultView(0)("qud_itmsts").ToString = "OLD" Then
                            .Tables("RESULT").DefaultView(index)("UPD") = "N"
                            .Tables("RESULT").DefaultView(index)("no") = id
                            id = id + 1
                        End If
                    End If
                    sFilter = ""
                ...
                sFilter = "UPD<>'N'"
                .Tables("RESULT").DefaultView.RowFilter = sFilter

                If .Tables("RESULT").DefaultView.Count > 0 Then
                    Dim index As Integer = .Tables("RESULT").DefaultView.Count

                    While index > 0
                        .Tables("RESULT").DefaultView(0).Delete()
                        index -= 1
                    End While
                    .Tables("RESULT").AcceptChanges()
                End If
                sFilter = ""
                .Tables("RESULT").DefaultView.RowFilter = sFilter
                ...
                If .Tables("RESULT").DefaultView.Count > 0 Then
                    txtFm.Text = "1"
                    txtTo.Text = .Tables("RESULT").DefaultView.Count
                End If
            End With
        End If
    ...
    Private Sub CalculatePrc(ByVal strItem As String, ByVal intSeq As Integer)
        ...
        'S = "㊣QUOTNDTL_Vendor_wCust2※S※" & strItem & "※" & _
                ...
                If strCurCde2 = dr(0)("ysi_cde") Then
                    ...
                    If ma.rs_QUCSTEMT.Tables.Count > 0 Then
                        If ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count > 0 Then
                            ...
                            For i = 0 To ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count - 1
                                If ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("mode").ToString <> "DEL" Then
                                    If CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent"))) <> 0 Then
                                        cus1sp = ((CDec(IIf(cus1sp = 0, 0, cus1sp)) / _
                                                (100 - CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent"))))) * 100) * _
                                                dr(0)("ysi_selrat")
                                    End If

                                    If CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt"))) <> 0 Then
                                        dblCstEmtAmt = CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt"))) * dr(0)("ysi_selrat")
                        ...
                        If ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count > 0 Then
                            ...
                            For i = 0 To ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count - 1
                                If ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("mode").ToString <> "DEL" Then
                                    ...
                                    If CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt"))) <> 0 Then
                                        dblCstEmtAmt = CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt"))) / _
                                                        dr(0)("ysi_selrat")
                                        cus1sp = CStr(CDec(IIf(cus1sp = 0, 0, cus1sp)) + dblCstEmtAmt)
                                    End If
                                End If
                    ...
                    If ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count > 0 Then
                        ...
                        For i = 0 To ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count - 1
                            If ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("mode").ToString <> "DEL" Then
                                If CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent"))) <> 0 Then
                                    cus1sp = (CDec(IIf(cus1sp = 0, 0, cus1sp)) / _
                                            (100 - CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_percent"))))) * 100
                                End If

                                If CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt"))) <> 0 Then
                                    dblCstEmtAmt = CDec(IIf(IsDBNull(ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")) = True, 0, ma.rs_QUCSTEMT.Tables("RESULT").Rows(i)("qce_amt")))
                                    cus1sp = CStr(CDec(IIf(cus1sp = 0, 0, cus1sp)) + dblCstEmtAmt)
                                End If
                            End If
                            dblCstEmtPert = 0
...
EvalErr:
    ...
    Private Sub cmdApply_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdApply.Click
        Dim opt As String
        Dim intFm As Long
        Dim intTo As Long
    ...
    Private Sub cmdUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUpdate.Click
        ...
        If MsgBox("Are you sure to Renew all the item(s)?", vbQuestion + vbYesNo, "Question") = vbYes Then

            'save current seq
            'Call ma.fill_QUOTNDTL()
            If ma.rs_QUOTNDTL.Tables("RESULT").Rows(ma.sReadingIndexQ).Item("qud_creusr") = "~*ADD*~" Or ma.rs_QUOTNDTL.Tables("RESULT").Rows(ma.sReadingIndexQ).Item("qud_creusr") = "~*NEW*~" Then
            ...
            For index As Integer = 0 To rs_Result.Tables("RESULT").Rows.Count - 1
                If rs_Result.Tables("RESULT").Rows(index).Item("UPD") = "Y" Then
                    ...
                    For i As Integer = 0 To ma.rs_QUOTNDTL.Tables("RESULT").Rows.Count - 1
                        If ma.rs_QUOTNDTL.Tables("RESULT").Rows(i)("qud_qutseq") = rs_Result.Tables("RESULT").Rows(index)("qud_qutseq") Then
                            find_sReadingIndexQ = i
                        End If
                    Next

                    '''20130909 
                    temp_PckCstAmt = ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_pkgper")
                    temp_ItmCommAmt = ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_icmper")
                    '                    temp_cboColCde_SelectedText = rs_Result.Tables("RESULT").Rows(index).Item("vw_colcde")
                    '                   temp_cboPcking_SelectedText = rs_Result.Tables("RESULT").Rows(index).Item("vw_pckunt")
                    '''20130909 
                    ''' pack & color 
                    temp_cboColCde_SelectedText = ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_colcde")

                    temp_cboPcking_SelectedText = ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_untcde").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_inrqty").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_mtrqty").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_cft").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_cbm").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_ftyprctrm").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_prctrm").ToString.Trim + " / " + _
            ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_trantrm").ToString.Trim



                    '''update each item
                    ma.sReadingIndexQ = find_sReadingIndexQ
                    If ma.rs_QUOTNDTL.Tables("RESULT").Rows(ma.sReadingIndexQ).Item("qud_creusr") = "~*ADD*~" Or ma.rs_QUOTNDTL.Tables("RESULT").Rows(ma.sReadingIndexQ).Item("qud_creusr") = "~*NEW*~" Then
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(ma.sReadingIndexQ).Item("qud_creusr") = "~*NEW*~"
                    End If

                    Dim qutseq As Integer
                    qutseq = ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_qutseq")

                    'ma.find_sReadingIndexQ = find_sReadingIndexQ
                    Call ma.set_sReadingIndexQ(find_sReadingIndexQ)
                    ...
                    'no paccking or princing mssing for the renewed item!
                    If ma.gf_packing_miss = False Then
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_itmsts") = "CMP"
                    Else
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_itmsts") = "INC"
                    End If

                    If ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_creusr") = "~*ADD*~" Or ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_creusr") = "~*NEW*~" Then
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_creusr") = "~*NEW*~"
                    Else
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qud_creusr") = "~*UPD*~"
                    End If

                    If ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_creusr") = "~*ADD*~" Or ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_creusr") = "~*NEW*~" Then
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_creusr") = "~*NEW*~"
                    Else
                        ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ).Item("qpe_creusr") = "~*UPD*~"
                    End If
                    ...
                    ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("qud_apprve") = ""
                    ma.rs_QUOTNDTL.Tables("RESULT").Rows(find_sReadingIndexQ)("mode") = "UPD"
                End If
        ...
        ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        MsgBox("Items Renewed / processed!")
        ...
        'If rs_Result.Tables.Count = 0 Then Exit Sub
        'If rs_Result.Tables("RESULT").Rows.Count <= 0 Then Exit Sub
        ...
        '    dgResult.DataSource = rs_Result.Tables("RESULT").DefaultView
        '    Call Display()
        '    MsgBox("No record marked 'Y'!" & vbCrLf & "To update a record, please mark the 'UPD' column 'Y'.")
        '    Exit Sub
        'End If
        ...
        '        Call updateQuotation(intSeq, strItem, strColor, strPacking, strAlsItmno, strAlsColcde)
    ...
    Private Sub updateQuotation(ByVal intSeq As Integer, ByVal strItem As String, ByVal strColor As String, ByVal strPacking As String, ByVal strAlsItmno As String, ByVal strAlsColcde As String)
        qutseq = 0
        stkqty_tmp = 0
        cusqty_tmp = 0
        smpqty_tmp = 0
        ...
        If rtnLong <> RC_SUCCESS Then
            Cursor = Cursors.Default
            save_ok = False
            MsgBox("Error on loading updateQuotation sp_select_IMBASINF_Q :" & rtnStr)
            Exit Sub
        End If
        ...
        Else
            ...
            'S = "㊣IMCOLINF※S※" & strItem & "㊣IMPCKINF_Q※S※" & strItem & "㊣IMMATBKD※S※" & strItem & "㊣IMBOMASS_Q※S※" & strItem & "㊣IMPRCINF_Q※S※" & strItem
            'rs = objBSGate.Enquire(gsConnStr, "sp_general", S)
            ...
            If rtnLong <> RC_SUCCESS Then
                Cursor = Cursors.Default
                save_ok = False
                MsgBox("Error on loading updateQuotation sp_select_IMCOLINF :" & rtnStr)
                Exit Sub
            End If
        ...
        If Len(strPacking) > 0 Then
            ...
            If rtnLong <> RC_SUCCESS Then
                Cursor = Cursors.Default
                save_ok = False
                MsgBox("Error on loading updateQuotation sp_select_CUBASINF_Q :" & rtnStr)
                Exit Sub
            End If
        ...
        'S = "㊣CUITMSUM_Q2※S※" & cus1no & "※" & cus2no & "※" & _
        ...
        If rtnLong <> RC_SUCCESS Then
            Cursor = Cursors.Default
            save_ok = False
            MsgBox("Error on loading updateQuotation sp_select_CUITMSUM_Q :" & rtnStr)
            Exit Sub
        End If
        ...
        If rs_CUITMSUM.Tables("RESULT").Rows.Count > 0 Then
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading updateQuotation sp_select_IMCUSSTY_QU :" & rtnStr)
                Cursor = Cursors.Default
                Exit Sub
            End If
        ...
        If Not rs_IMVENINF.Tables("RESULT") Is Nothing Then
        ...
        Else
            ...
            ma.rs_QUOTNDTL.Tables("RESULT").DefaultView(0)("qud_qutdat") = "01/01/1900"
        End If
        ...
        '*** Copy the original discount or set zero
        ...
        If ma.cboCus2No.Text <> "" Then
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading updateQuotation sp_select_cucstemt_qu 1 :" & rtnStr)
                Exit Sub
            End If
        ...
        If strCusno = Microsoft.VisualBasic.Left(ma.cboCus1No.Text, InStr(ma.cboCus1No.Text, " - ") - 1) Then
            ...
            If rtnLong <> RC_SUCCESS Then
                save_ok = False
                MsgBox("Error on loading updateQuotation sp_select_cucstemt_qu 2 :" & rtnStr)
                Exit Sub
            End If
        End If
        ...
        If ma.rs_QUCSTEMT.Tables.Count > 0 Then
            ...
            If ma.cboCus2No.Text <> "" Then
                ...
                If rtnLong <> RC_SUCCESS Then
                    MsgBox("Error on loading updateQuotation sp_select_CUCSTAMT_qu 1 :" & rtnStr)
                    Exit Sub
                End If
            ...
            If strCusno = Microsoft.VisualBasic.Left(ma.cboCus1No.Text, InStr(ma.cboCus1No.Text, " - ") - 1) Then
                ...
                If rtnLong <> RC_SUCCESS Then
                    save_ok = False
                    MsgBox("Error on loading updateQuotation sp_select_CUCSTAMT_qu 2 :" & rtnStr)
                    Exit Sub
                End If
            End If
            ...
            If rsTmp.Tables("RESULT").Rows.Count > 0 Then
                For index As Integer = 0 To ma.rs_QUCSTEMT.Tables("RESULT").Rows.Count - 1
                    sFilter = "cca_cecde = '" + ma.rs_QUCSTEMT.Tables("RESULT").Rows(index)("qce_cecde") + "' and " + _
                    ...
                    If rsTmp.Tables("RESULT").DefaultView.Count > 0 Then
                        ma.rs_QUCSTEMT.Tables("RESULT").Rows(index)("cce_amt_d") = ma.rs_QUCSTEMT.Tables("RESULT").Rows(index)("cce_amt_d") / rsTmp.Tables("RESULT").DefaultView(0)("cca_estqty")
                        ma.rs_QUCSTEMT.Tables("RESULT").Rows(index)("qce_amt") = ma.rs_QUCSTEMT.Tables("RESULT").Rows(index)("cce_amt_d")
                    End If
                Next
            End If
        ...
        If ma.cboCus2No.Text <> "" Then
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading updateQuotation sp_select_cuelc_qu 1 :" & rtnStr)
                Exit Sub
            End If
        ...
        If strCusno = Microsoft.VisualBasic.Left(ma.cboCus1No.Text, InStr(ma.cboCus1No.Text, " - ") - 1) Then
            ...
            If rtnLong <> RC_SUCCESS Then
                save_ok = False
                MsgBox("Error on loading updateQuotation sp_select_cuelc_qu 2 :" & rtnStr)
                Exit Sub
            End If
        End If
        ...
        If ma.rs_QUELC.Tables.Count > 0 Then
            ...
            If ma.rs_QUELC.Tables("RESULT").DefaultView.Count > 0 Then
                For index As Integer = 0 To ma.rs_QUELC.Tables("RESULT").Rows.Count - 1
        ...
        If ma.cboCus2No.Text <> "" Then
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading updateQuotation sp_select_cuelcdtl_qu 1 :" & rtnStr)
                Exit Sub
            End If
        ...
        If strCusno = Microsoft.VisualBasic.Left(ma.cboCus1No.Text, InStr(ma.cboCus1No.Text, " - ") - 1) Then
            ...
            If rtnLong <> RC_SUCCESS Then
                save_ok = False
                MsgBox("Error on loading updateQuotation sp_select_cuelcdtl_qu 2 :" & rtnStr)
                Exit Sub
            End If
        End If
            ...
            If strFml <> "" Then
                If ma.rs_QUELC.Tables.Count > 0 Then
                    If ma.rs_QUELC.Tables("RESULT").Rows.Count > 0 Then
                        For index As Integer = 0 To ma.rs_QUELC.Tables("RESULT").Rows.Count - 1
                            If ma.rs_QUELC.Tables("RESULT").Rows(index)("mode").ToString <> "DEL" Then
                                If ma.rs_QUELC.Tables("RESULT").Rows(index)("qec_grpcde").ToString = "001" Then
                                    dblELC = CDec(ma.rs_QUELC.Tables("RESULT").Rows(index)("qec_amt"))
                                    Exit For
                                End If
                            End If
                        Next
        ...
        If ma.rs_QUELC.Tables.Count > 0 Then
            If ma.rs_QUELC.Tables("RESULT").Rows.Count > 0 Then
                For index As Integer = 0 To ma.rs_QUELC.Tables("RESULT").Rows.Count - 1
                    If ma.rs_QUELC.Tables("RESULT").Rows(index)("mode").ToString <> "DEL" Then
                        If ma.rs_QUELC.Tables("RESULT").Rows(index)("qec_grpcde").ToString = "001" Then
                            dblELC = CDec(IIf(IsDBNull(ma.rs_QUELC.Tables("RESULT").Rows(index)("qec_amt")) = True, 0, ma.rs_QUELC.Tables("RESULT").Rows(index)("qec_amt")))
                            Exit For
                        End If
                    End If
                Next
    ...
    Private Sub CalculateELCDuty(ByVal dblDuty As Double)
        If ma.rs_QUELCDTL.Tables.Count > 0 Then
            If ma.rs_QUELCDTL.Tables("RESULT").Rows.Count > 0 Then
                For index As Integer = 0 To ma.rs_QUELCDTL.Tables("RESULT").Rows.Count - 1
                    If ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("ced_cedsc").ToString = "Duty" And _
                        ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("mode").ToString <> "DEL" Then
                        ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("qed_percent") = dblDuty
    ...
    Private Sub CalculateELCTran()
        ...
        If ma.rs_QUELCDTL.Tables.Count > 0 Then
            If ma.rs_QUELCDTL.Tables("RESULT").Rows.Count > 0 Then
                For index As Integer = 0 To ma.rs_QUELCDTL.Tables("RESULT").Rows.Count - 1
                    If Trim(ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("ced_cedsc").ToString) = "Transportation" And _
                            ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("mode").ToString <> "DEL" Then
                        ...
                        If CDec(IIf(IsDBNull(ma.rs_QUOTNDTL.Tables("RESULT").DefaultView(0)("qud_cus2dp")) = True, "0", ma.rs_QUOTNDTL.Tables("RESULT").DefaultView(0)("qud_cus2dp"))) <> 0 Then
                        ...
                        If decAjdPrc = 0 Then
                            ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("qed_amt") = 0
                            ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("qed_percent") = 0
                        Else
                            ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("qed_amt") = dblTrans
                            ma.rs_QUELCDTL.Tables("RESULT").Rows(index)("qed_percent") = round((dblTrans / decAjdPrc) * 100, 2)
                        End If
    ...
    Private Sub dgResult_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgResult.CellClick
        If e.RowIndex > -1 And e.ColumnIndex > -1 Then
            ...
            If e.ColumnIndex = btnUpd Then
                ...
                End If
                rs_Result.Tables("RESULT").AcceptChanges()
            ElseIf e.ColumnIndex = btnNewItem Then
                CellClickRow = e.RowIndex
                CellClickCol = e.ColumnIndex

                CellClickOldItem = rs_Result.Tables("RESULT").DefaultView(e.RowIndex)("qud_itmno")
                CellClickQutSeq = rs_Result.Tables("RESULT").DefaultView(e.RowIndex)("qud_qutseq")
                newitem = ""
                newcolor = ""

                Call dropdownCombo(dgResult, "Item")
                'ElseIf e.ColumnIndex = btnNewPck Then
                '    CellClickRow = e.RowIndex
                '    CellClickCol = e.ColumnIndex
                ...
                '    Call dropdownCombo(dgResult, "Pck")
            End If
        End If
    End Sub
    ...
    Private Sub dropdownCombo(ByVal dgv As DataGridView, ByVal typ As String)
        ...
        Select Case typ
            Case "Item"
                ...
                If rs_List.Tables("RESULT").DefaultView.Count > 0 Then
                    For index As Integer = 0 To rs_List.Tables("RESULT").DefaultView.Count - 1
                        If Not (newitem = rs_List.Tables("RESULT").DefaultView(index)("vw_itmno").ToString And _
                                newcolor = rs_List.Tables("RESULT").DefaultView(index)("vw_colcde").ToString) Then
                ...
                '    If rs_List.Tables("RESULT").DefaultView.Count > 0 Then
                '        For index As Integer = 0 To rs_List.Tables("RESULT").DefaultView.Count - 1
                '            cboCell.Items.Add(rs_List.Tables("RESULT").DefaultView(index)("vw_pckunt").ToString)
                '        Next
                '    End If
                '    sFilter = ""
                '    rs_List.Tables("RESULT").DefaultView.RowFilter = sFilter
    ...
    Private Sub textboxCombo(ByVal dgv As DataGridView, ByVal typ As String)
        ...
        Dim iRow As Integer = CellClickRow
        Dim iCol As Integer = CellClickCol
        ...
        Select typ
            Case "Item"
                                        ...
                                        If rs_Result.Tables("RESULT").DefaultView.Count > 0 Then
                                            For index1 As Integer = 0 To rs_Result.Tables("RESULT").DefaultView.Count - 1
                                                If rs_Result.Tables("RESULT").DefaultView(index1)("qud_qutseq").ToString <> strQutSeq And _
                                                    ...
                                                    rs_Result.Tables("RESULT").DefaultView(index1)("vw_pckunt") = rs_List.Tables("RESULT").DefaultView(index)("vw_pckunt") Then
                                                    MsgBox("Duplicated Item & Color!", vbCritical, "Invalid Input")
                                                    Exit Sub
                                                End If
                                            Next
                                        End If
                ...
                '    dgv.Rows(iRow).Cells("vw_pckunt").Value = strTemp
    ...
    Private Sub dgResult_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgResult.CellEndEdit
        If e.RowIndex >= 0 Then
            If e.ColumnIndex = btnNewItem Then
                textboxCombo(dgResult, "Item")
                'ElseIf e.ColumnIndex = btnNewPck Then
                '    textboxCombo(dgResult, "Pck")
            End If
        End If
    End Sub
