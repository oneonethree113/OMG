...
Public Class PGM00002
    ...
    Private Sub SetdgPkgITem()
        ...
        dgPkgItem_assitem = i
        dgPKGITEM.Columns(i).Visible = True
        dgPKGITEM.Columns(i).HeaderText = "Ass. Item"
        dgPKGITEM.Columns(i).Width = 120
        dgPKGITEM.Columns(i).ReadOnly = True
        ...
        dgPkgITem_cusitem = i
        dgPKGITEM.Columns(i).Visible = True
        dgPKGITEM.Columns(i).HeaderText = "Cust.Item#"
        ...
        dgPKGITEM.Columns(i).Visible = True
        dgPKGITEM.Columns(i).HeaderText = "Tmp.Item No"
        dgPKGITEM.Columns(i).Width = 120
        dgPKGITEM.Columns(i).ReadOnly = True
        i = i + 1
        dgPkgITem_venitem = i
        dgPKGITEM.Columns(i).Visible = True
        dgPKGITEM.Columns(i).HeaderText = "Ven.Item No"
        dgPKGITEM.Columns(i).Width = 120
        dgPKGITEM.Columns(i).ReadOnly = True
        i = i + 1
        dgPkgITem_venno = i
    ...
    Public Sub cmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFind.Click
        ...
        If rs_PKREQHDR.Tables("RESULT").Rows(0).Item("prh_status") = "REL" Then
            mode = "ReadOnly"
    ...
    Private Sub update_PKREQDTL()
        ...
        rs_PKREQDTL.Tables("RESULT").Rows(loc).Item("prd_multip") = 0 'care txtPkgMult.Text
    ...
    Private Sub txtPkgOrdQty_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPkgOrdQty.TextChanged
        If flag_panpack_keypress = True Then
            ...
            'If IsNumeric(txtPkgOrdQty.Text) Then
            ...
            '    If rs.Tables("RESULT").Rows.Count <> 0 Then
            '        If rs.Tables("RESULT").Rows(0).Item("pwa_um") = "%" Then

            '            txtPkgWastPer.Text = Fix(rs.Tables("RESULT").Rows(0).Item("pwa_wasage"))
            '            txtPkgWast.Text = txtPkgOrdQty.Text * rs.Tables("RESULT").Rows(0).Item("pwa_wasage") / 100

            '        Else
            '            txtPkgWastPer.Text = ""
            '            txtPkgWast.Text = Fix(rs.Tables("RESULT").Rows(0).Item("pwa_wasage"))
            '        End If
            ...
            ' txtPkgWast.Text = Fix(txtPkgOrdQty.Text * txtPkgWastPer.Text / 100)
            calTotalOrdQty()
            calTotalAMT()
        End If
    End Sub
    ...
    Private Function CheckValid() As Boolean
        ...
        Else
            ...
            If Trim(txtPkgOrdQty.Text) = 0 Then
    ...
    Private Function save_PKREQDTL() As Boolean
        ...
        For i As Integer = 0 To rs_PKREQDTL.Tables("RESULT").Rows.Count - 1
            ...
            multip = 0 'rs_PKREQDTL.Tables("RESULT").Rows(i).Item("prd_multip")'care txtPkgMult.Text
            ...
            ElseIf cresur = "~*UPD*~" Then
                ...
                gspStr = "sp_update_PKREQDTL '" & cocde & "','" & reqno & "'," & seq & "," & multip & "," & ordqty & "," & wasper & "," & _
                                          ...
                                          quoteprice & ",'" & cntper & "','" & Tel & "','" & curcde & "','" & gsUsrID & "'"
        ...
        For i As Integer = 0 To rs_PKREQDTL.Tables("RESULT").Rows.Count - 1
            ...
            Else
                If IsNumeric(rs_PKREQDTL.Tables("RESULT").Rows(i).Item("prd_ordqty")) = False Then
                    ...
                    Return False
                    Exit Function
                ElseIf rs_PKREQDTL.Tables("RESULT").Rows(i).Item("prd_ordqty") = 0 Then
                    display_PKREQDTL(i)
                    MsgBox("Order Qty cannot be zero")
                    txtPkgOrdQty.Focus()
                    Return False
                    Exit Function
                End If
    ...
    Private Sub dgSummary_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgSummary.CellEnter
    ...
    Private Sub dgSummary_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgSummary.CellValidated
        ...
        If row.Cells(e.ColumnIndex).IsInEditMode Then
            Select Case e.ColumnIndex
                ...
                Case dgSum_UnitPrc, dgSum_ordqty
                    Dim ordqty As Integer
                    Dim unitprice As Decimal
                    Dim ttlordqty As Integer
                    ...
                    ttlordqty = ordqty
                    ttlamt = round(ordqty * unitprice, 2)
    ...
    Private Sub dgPKGITEM_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgPKGITEM.CellContentClick
    ...
    Private Sub txtQuotePrice_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtQuotePrice.TextChanged
    ...
    Private Sub SetdgPKESHDR()
        ...
        dgPKESHDR.Columns(i).Visible = False
        i = i + 1
        dgPKESHDR.Columns(i).HeaderText = "Item No"
        dgPKESHDR.Columns(i).Width = 110
        dgPKESHDR.Columns(i).ReadOnly = True
        i = i + 1
        dgPKESHDR.Columns(i).HeaderText = "Ass.item"
        dgPKESHDR.Columns(i).Width = 85
        dgPKESHDR.Columns(i).ReadOnly = True
        i = i + 1
        dgPKESHDR.Columns(i).HeaderText = "Tmp.item"
        ...
        dgPKESHDR.Columns(i).ReadOnly = True
        i = i + 1
        dgPKESHDR.Columns(i).HeaderText = "Ven.item"
        dgPKESHDR.Columns(i).Width = 80
        dgPKESHDR.Columns(i).ReadOnly = True
        i = i + 1
    ...
    Private Sub SetdgPKESDTL(ByVal value As String)
        ...
        dgPKESDTL.Columns(i).Visible = False
        i = i + 1
        dgPKESDTL.Columns(i).HeaderText = "Pack. Item"
    ...
    Private Sub dgPKESHDR_CellContentClick_1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgPKESHDR.CellContentClick

    End Sub
    Private Sub dgPKESHDR_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
