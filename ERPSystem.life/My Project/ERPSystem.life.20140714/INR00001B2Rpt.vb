...
Public Class INR00001B2Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.INR00001B2Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINR00001B2Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INR00001B2Rpt = New INR00001B2Rpt
        rpt.Site = Me.Site
        Return rpt
    End Function
