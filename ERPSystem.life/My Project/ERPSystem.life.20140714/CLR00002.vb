...
Public Class CLR00002
    Inherits System.Windows.Forms.Form

    Public rs_SYMUSRCO As New DataSet
    Public rs_CLR00002 As New DataSet

    Dim rowCnt As Integer
    Dim dsNewRow As DataRow
    Dim mode As String

    Private Sub CLR00002_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdShow_Click1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        'gspStr = "sp_list_CLR00002_dt '','H','" & _
        '            COCDELIST & "','" & _
        '            CUS1NOLIST & "','" & _
        '            CUS2NOLIST & "','" & _
        '            ITMNOLIST & "','" & _
        ...
        'If rtnLong <> RC_SUCCESS Then
        'MsgBox("Error on loading CLR00002 #002 sp_list_CLR00002 : " & rtnStr)
        'Else
        ...
        gspStr = "sp_list_CLR00002_dt '','D','" & _
                    COCDELIST & "','" & _
                    CUS1NOLIST & "','" & _
                    CUS2NOLIST & "','" & _
                    ITMNOLIST & "','" & _
        ...
        rtnLong = execute_SQLStatementRPT_ADO(gspStr, rs, rtnStr)
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading CLR00002 #002 sp_list_CLR00002_dt : " & rtnStr)
        Else
            If rs.RecordCount = 0 Then
                MsgBox("No record found!")
            Else
                If temp_chk_donot_show_dtl = "Y" Then
                    Call ExportToExcel_donot_show_dtl(rs)
                Else
                    Call ExportToExcel(rs)
                End If
