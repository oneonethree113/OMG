Public Class SAM00005
    ...
    Private Sub Display_Detail(ByVal grd As DataGridView)
        ...
        With grd
            ...
            .Columns(7).HeaderCell.Value = "Vendor Item No"
            ...
            .Columns(10).HeaderCell.Value = "Packing & Terms"
            ...
            For i = 0 To rs_SAORDDTL_tmp_sorttable.Rows.Count - 1
                If rs_SAORDDTL_tmp_sorttable.Rows(i).Item("gen") = "Y" Then
                    ...
                    If LTrim(CoCde) <> LTrim(rs_SAORDDTL_tmp_sorttable.Rows(i).Item("quh_cocde")) Or LTrim(cus1no_) <> LTrim(rs_SAORDDTL_tmp_sorttable.Rows(i).Item("quh_cus1no")) Or LTrim(cus2no) <> LTrim(rs_SAORDDTL_tmp_sorttable.Rows(i).Item("quh_cus2no")) Then
                        ...
                        Dim smpPrd As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cpi_smpprd")
                        Dim smpFgt As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cpi_smpfgt")
                        Dim curcde As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cpi_curcde")
                        ...
                        Dim txtCus1Ad As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntadr").ToString
                        Dim txtCus2AD As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntadr2").ToString
                        Dim txtCus1St As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntstt").ToString
                        Dim cboCus1Cy As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntcty").ToString
                        Dim txtCus1Zp As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntpst").ToString
                        Dim txtCus2St As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntstt2").ToString
                        Dim cboCus2Cy As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntcty2").ToString
                        Dim txtCus2Zp As String = rs_SAORDDTL_tmp_sorttable.Rows(i).Item("cci_cntpst2").ToString
