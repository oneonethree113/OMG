Public Class SYM00108
    ...
    Private Sub SYM00108_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading SYM00108 sp_select_CLCUREX : " & rtnStr)
            Else
        ...
        If flgMod Then
            ...
            If YNC = Windows.Forms.DialogResult.Yes Then
                If Enq_right_local Then
                    ...
                    If save_ok Then
                        Call SYM00108_Load(Nothing, Nothing)
                    Else
                        Exit Sub
                    End If
                Else
    ...
    Private Sub cmdSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading SYM00108 sp_update_CLCUREX : " & rtnStr)
    ...
    Private Sub SYM00108_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim YNC As Integer
        Dim flgMod As Boolean = False
