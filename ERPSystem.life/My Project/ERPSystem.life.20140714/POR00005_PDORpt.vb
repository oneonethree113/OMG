...
Public Class POR00005_PDORpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.POR00005_PDORpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPOR00005_PDORpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As POR00005_PDORpt = New POR00005_PDORpt
        rpt.Site = Me.Site
        Return rpt
    End Function
