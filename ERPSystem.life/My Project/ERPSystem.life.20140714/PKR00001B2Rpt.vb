...
Public Class PKR00001B2Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.PKR00001B2Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPKR00001B2Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PKR00001B2Rpt = New PKR00001B2Rpt
        rpt.Site = Me.Site
        Return rpt
    End Function
