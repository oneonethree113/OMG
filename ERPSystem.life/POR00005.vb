...
Public Class POR00005
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        If optJob.Checked = True Or optPO.Checked = True Or optRunNo.Checked = True Then
            ...
            gspStr = "sp_select_POR00005_check '" & cboCoCde.Text & "','" & sJPR & "','" & sFm & "','" & sTo & "'"
            Me.Cursor = Windows.Forms.Cursors.WaitCursor
            rtnLong = execute_SQLStatement(gspStr, rs, rtnStr)
            If rtnLong <> RC_SUCCESS Then
                Me.Cursor = Windows.Forms.Cursors.Default
                MsgBox("Error on loading POR00005 #001 sp_select_POR00005_check : " & rtnStr)
                Exit Sub
            Else
                If rs.Tables("RESULT").Rows.Count = 1 Then
                    If rs.Tables("RESULT").Rows(0).Item("invalid_count") > 0 Then
                        Me.Cursor = Windows.Forms.Cursors.Default
                        MsgBox("Not all PN in CLO or REL Status with Final Approved")
                        Exit Sub
                    End If
                End If
            End If
