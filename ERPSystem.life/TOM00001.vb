Public Class TOM00001
    ''PLEASE NEVER USE NULL AS FLAG!!!!!!!!!!!!
    ''THERE WILL BE TONS OF EXCEPTION !!!!!!!!!
    Dim mode As String
    ...
    Public Current_Col As Integer = 0
...
#End Region
    ...
    Private Sub resetcmdButton(ByVal m As String)
        If m = "INIT" Then
            ...
            freeze_TabControl(0)
        ElseIf m = "ADD" Then 'this code should never be run
            Me.mmdAdd.Enabled = False
        ...
        ElseIf m = "UPDATE" Then
            ...
            'The summary function cannot search TO never released
    ...
    Private Sub mmdFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdFind.Click
        ...
        StatusBar.Panels(1).Text = Format(rs_TOORDHDR.Tables("RESULT").Rows(0)("toh_credat"), "MM/dd/yyyy") & _
                                    " " & Format(rs_TOORDHDR.Tables("RESULT").Rows(0)("toh_upddat"), "MM/dd/yyyy") & _
                                    " " & rs_TOORDHDR.Tables("RESULT").Rows(0)("toh_updusr").ToString()
    ...
    Private Sub display_TODtl(ByVal seq As Integer, ByVal ver As Integer)
        ...
        txtCtnDL.Text = Format(Val(rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ctnL").ToString), "##0.####")
        txtCtnDW.Text = Format(Val(rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ctnW").ToString), "##0.####")
        txtCtnDH.Text = Format(Val(rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ctnH").ToString), "##0.####")
        ...
        ElseIf txtLatest.Text = "Y" Then
            ...
            End If
        End If
        '''''''''''''''''''''''''''''''Set 'Back','Next' button status
        Dim locIndataGrid As Integer
        locIndataGrid = -1
        ...
        If locIndataGrid < dgTODtl.RowCount - 1 Then
            CmdDtlNext.Enabled = True
        Else
            CmdDtlNext.Enabled = False
        End If
        If locIndataGrid <= 0 Then
            CmdDtlPre.Enabled = False
        Else
            CmdDtlPre.Enabled = True
        End If
    ...
    Private Sub display_dgTO()
        ...
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '3
        dgTODtl_tod_verno = i
        ...
        dgTODtl.Columns(i).HeaderText = "Latest"
        ...
        i = i + 1 '6
        dgTODtl_tod_sts = i
        dgTODtl.Columns(i).HeaderText = "Matching No."
        dgTODtl.Columns(i).Width = 90
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '7
        dgTODtl_tod_sts = i
        dgTODtl.Columns(i).HeaderText = "ItmSts"
        dgTODtl.Columns(i).Width = 60
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+7
        dgTODtl_tod_sts = i
        dgTODtl.Columns(i).HeaderText = "QUSts"
        dgTODtl.Columns(i).Width = 60
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+8
        dgTODtl_tod_todat = i
        ...
        dgTODtl.Columns(i).Width = 80
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Format = "MM/dd/yyyy"
        i = i + 1 '1+9
        ...
        dgTODtl.Columns(i).HeaderText = "Item Dscription"
        dgTODtl.Columns(i).Width = 200
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+19
        dgTODtl_tod_venno = i
        dgTODtl.Columns(i).HeaderText = "Vendor No."
        dgTODtl.Columns(i).Width = 160
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+20
        dgTODtl_tod_venitm = i
        dgTODtl.Columns(i).HeaderText = "Vendor Item"
        dgTODtl.Columns(i).Width = 100
        dgTODtl.Columns(i).ReadOnly = True
        ...
        dgTODtl.Columns(i).HeaderText = "Inner"
        dgTODtl.Columns(i).Width = 40
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+23
        dgTODtl_tod_mtrqty = i
        dgTODtl.Columns(i).HeaderText = "Master"
        dgTODtl.Columns(i).Width = 40
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+24
        ...
        i = i + 1 '1+28
        dgTODtl_tod_cft = i
        dgTODtl.Columns(i).HeaderText = "Fty Term"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+29
        dgTODtl_tod_cft = i
        dgTODtl.Columns(i).HeaderText = "HK Term"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+30
        dgTODtl_tod_cft = i
        dgTODtl.Columns(i).HeaderText = "Tran Term"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+31
        ...
        dgTODtl.Columns(i).HeaderText = "FOB PORT"
        dgTODtl.Columns(i).Width = 60
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+33
        ...
        dgTODtl.Columns(i).HeaderText = "Fty Shp Str"
        dgTODtl.Columns(i).Width = 80
        If mode <> "READ" Then
            dgTODtl.Columns(i).ReadOnly = False
        End If
        ...
        dgTODtl.Columns(i).HeaderText = "Fty Shp End"
        dgTODtl.Columns(i).Width = 80
        If mode <> "READ" Then
            dgTODtl.Columns(i).ReadOnly = False
        End If
        ...
        i = i + 1 '1+42
        dgTODtl_tod_rmk = i
        dgTODtl.Columns(i).HeaderText = "Customer PO"
        dgTODtl.Columns(i).Width = 80
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+43
        dgTODtl_tod_rmk = i
        ...
        i = i + 1 '1+45
        dgTODtl_tod_ctnL = i
        dgTODtl.Columns(i).HeaderText = "Ctn L(cm)"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+46
        dgTODtl_tod_ctnW = i
        dgTODtl.Columns(i).HeaderText = "Ctn W(cm)"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+47
        dgTODtl_tod_ctnH = i
        dgTODtl.Columns(i).HeaderText = "Ctn H(cm)"
        dgTODtl.Columns(i).Width = 65
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+48
        dgTODtl_tod_ctnupc = i
        dgTODtl.Columns(i).HeaderText = "Ctn UPC No."
        dgTODtl.Columns(i).Width = 70
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+49
        dgTODtl_tod_venstk = i
        dgTODtl.Columns(i).HeaderText = "Vendor Stock"
        dgTODtl.Columns(i).Width = 100
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+50
        dgTODtl_tod_cushpdatstr = i
        dgTODtl.Columns(i).HeaderText = "Cust Shp Str"
        dgTODtl.Columns(i).Width = 80
        If mode <> "READ" Then
            dgTODtl.Columns(i).ReadOnly = False
        End If
        ...
        dgTODtl.Columns(i).HeaderText = "Cust Shp End"
        dgTODtl.Columns(i).Width = 80
        If mode <> "READ" Then
            dgTODtl.Columns(i).ReadOnly = False
        End If
        ...
        dgTODtl.Columns(i).HeaderText = "Fty CCY"
        dgTODtl.Columns(i).Width = 55
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+53
        dgTODtl_tod_ftycst = i
        dgTODtl.Columns(i).HeaderText = "Fty Cst"
        dgTODtl.Columns(i).Width = 50
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+54
        dgTODtl_tod_curcde = i
        dgTODtl.Columns(i).HeaderText = "CCY"
        dgTODtl.Columns(i).Width = 40
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+55
        dgTODtl_tod_selprc = i
        dgTODtl.Columns(i).HeaderText = "Selling Price"
        dgTODtl.Columns(i).Width = 70
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+56
        dgTODtl_tod_selprc = i
        dgTODtl.Columns(i).HeaderText = "Basic Price"
        dgTODtl.Columns(i).Width = 70
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+57
        ...
        i = i + 1 '1+61
        dgTODtl_tod_qutno = i
        dgTODtl.Columns(i).HeaderText = "Quotation No."
        dgTODtl.Columns(i).Width = 80
        dgTODtl.Columns(i).ReadOnly = True
        i = i + 1 '1+62
        dgTODtl_tod_qutseq = i
        dgTODtl.Columns(i).HeaderText = "QU Seq."
        dgTODtl.Columns(i).Width = 50
        dgTODtl.Columns(i).ReadOnly = True
        dgTODtl.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        i = i + 1 '1+63
    ...
    Private Sub mmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdSave.Click
        '''''''''''''''''''''''
        'These 2 lines of codes in here is because the value 
        'of variables for updating will be changed only after the focus change, 
        'but clicking the save button will not change the focus. 
        'So these 2 lines can force the focus change
        txtPrjQty.Focus()
        txtDtlRmk.Focus()
        '''''''''''''''''''''''
    ...
    Private Sub CmdDtlPre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdDtlPre.Click
        ...
        If loc = 0 Then
            'Actually, this code should never been run becuase 
            'the Enabled property of button at loc=0  is disable
            MsgBox("First Record")
        End If
    ...
    Private Function save_TOORDDTL() As Boolean
        ...
        For i = 0 To rs_TOORDDTL.Tables("RESULT").Rows.Count - 1
            ...
            Dim tod_markup = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_markup")
            Dim tod_mrkprc = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_mrkprc")
            Dim tod_mumin = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_mumin")
            Dim tod_muminprc = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_muminprc")
            Dim tod_pckcst = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_pckcst")
            Dim tod_commsn = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_commsn")
            Dim tod_itmcom = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_itmcom")
            Dim tod_stdprc = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_stdprc")
            Dim tod_adjprc = rs_TOORDDTL.Tables("RESULT").Rows(i).Item("tod_adjprc")
            ...
            ElseIf TOD_CREUSR = "~*UPD*~" And TOD_LATEST = "Y" And TOD_VERNO <> HeaderVerno Then
                ...
                gspStr = "sp_insert_TOORDDTL_TOM0001 '" & gsCompany & "','" & TOD_TOORDNO & "'," & TOD_TOORDSEQ & "," & HeaderVerno & ",'" & _
                                   ...
                                   TOD_CNTCTP & "'," & tod_basprc & ",'" & tod_qutitmsts & "','" & _
tod_markup & "','" & _
tod_mrkprc & "','" & _
tod_mumin & "','" & _
tod_muminprc & "','" & _
...
tod_adjprc & "','" & _
        ...
        For i = 0 To rs_TODTLSHP.Tables("RESULT").Rows.Count - 1
            ...
            If dr.Length > 0 Then
                ...
                For i2 As Integer = 0 To dr.Length - 1
                    sumqty += dr(i2)("tds_shpqty")
                Next
                If Convert.ToInt32(txtPrjQty.Text) <> sumqty Then
                    If MsgBox("Do you want to Update the 'Project quantity' as the 'sum of Ship QTY' ?", vbYesNo) = vbYes Then
                        txtPrjQty.Text = sumqty
    ...
    Private Sub UpdateDetail()
        ...
        If txtFtyShpDateStr.Text = "  /  /" Then
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ftyshpdatstr") = "01/01/1900" 'DBNull.Value
        Else
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ftyshpdatstr") = txtFtyShpDateStr.Text
        End If

        If txtFtyShpDateEnd.Text = "  /  /" Then
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ftyshpdatend") = "01/01/1900" 'DBNull.Value
        Else
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_ftyshpdatend") = txtFtyShpDateEnd.Text
        End If

        If txtCustShpDateStr.Text = "  /  /" Then
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_cushpdatstr") = "01/01/1900" 'DBNull.Value
        Else
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_cushpdatstr") = txtCustShpDateStr.Text
        End If

        If txtCustShpDateEnd.Text = "  /  /" Then
            rs_TOORDDTL.Tables("RESULT").Rows(loc).Item("tod_cushpdatend") = "01/01/1900" 'DBNull.Value
        Else
...
#Region "Movable Panel"
    ...
    Private Sub panelMoveTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Select Case movePanel
            Case PanelMShp.Name
                SetPanelPosition(PanelMShp)
            Case Panel1.Name
                SetPanelPosition(Panel1)
        End Select


    End Sub

    Private Sub PanelMShp_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PanelMShpHeaderBar.MouseDown, PanelMShpHeader.MouseDown
        movePanel = PanelMShp.Name
        panelMoveTimer.Enabled = True
        panelMoveTimer.Start()
        RenewPanel(PanelMShp)
    End Sub

    Private Sub PanelMShp_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PanelMShpHeaderBar.MouseUp, PanelMShpHeader.MouseUp
        panelMoveTimer.Stop()
        RenewPanel(PanelMShp)
        movePanel = ""
    End Sub

    Private Sub Panel1_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Panel1HeaderBar.MouseDown, Panel1Header.MouseDown
        movePanel = Panel1.Name
        panelMoveTimer.Enabled = True
        panelMoveTimer.Start()
        RenewPanel(Panel1)
    End Sub

    Private Sub Panel1_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Panel1HeaderBar.MouseUp, Panel1Header.MouseUp
        panelMoveTimer.Stop()
        RenewPanel(Panel1)
        movePanel = ""
    End Sub
#End Region
    ...
    Private Sub Button3_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckWidth.Click
        Dim column As DataGridViewColumn = dgTODtl.Columns(Current_Col)
        MessageBox.Show("Col:" + Current_Col.ToString + ",Header: " + column.HeaderCell.Value.ToString + ",Wid:" + column.Width.ToString)

    End Sub

    Private Sub mmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdPrint.Click
        If Recordstatus = True Then
            MessageBox.Show("Tentative Order has been changed. Please save before print.")
        Else
            Dim TOM00005 As New TOM00005
            TOM00005.callByTOM01(txtTONo.Text, cboCoCde.Text)
    ...
    Private Sub SummaryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SummaryToolStripMenuItem.Click
        Dim TOM00004 As New TOM00004
        TOM00004.callByTOM01(txtTONo.Text)
    End Sub

    Private Sub ReleaseUnreleaseToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
