Public Class SYM00028
    ...
    Private Sub setStatus(ByVal mode As String)
        If mode = "INIT" Then
            ...
            mmdInsRow.Enabled = Del_right_local
    ...
    Private Sub fillcboSalesMgr()
        ...
        Dim dv As DataView = rs_SYUSRPRF_MGR.Tables("RESULT").DefaultView
        If Not dv.Count = 0 Then
            dv.Sort = "yup_upddat desc"
            Dim drv As DataRowView = dv(0)
            Me.StatusBar.Items("lblRight").Text = Format(drv.Item("yup_credat"), "MM/dd/yyyy") & " " & Format(drv.Item("yup_upddat"), "MM/dd/yyyy") & " " & drv.Item("yup_updusr")
    ...
    Private Sub dgSalMgr_RowHeaderMouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgSalMgr.RowHeaderMouseDoubleClick
        If mmdInsRow.Enabled = False Then
            Exit Sub
        End If
    ...
    Private Sub mmdSave_EnabledChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdSave.EnabledChanged
