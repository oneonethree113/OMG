Public Class SYM00004
    ...
    Private Sub cmdApply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdApply.Click
        ...
        If strLnTo > strLnFr Then
            MsgBox("Invalid formula apply range")
            Exit Sub
        End If
        ...
        If strLnFr <> "" AndAlso IsNumeric(strLnFr) AndAlso strLnFr >= 0 Then
            ...
            If strLnTo <> "" AndAlso IsNumeric(strLnTo) AndAlso strLnTo >= 0 Then
                ...
                If Not cboFml.SelectedItem Is Nothing AndAlso strLnTo >= strLnFr Then
                    ...
                    Next
                Else
                    MsgBox("Formula cannot be empty")
                End If
            Else
    ...
    Private Sub txtbox_keyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFromApply.KeyPress, txtToApply.KeyPress
    ...
    Private Sub DataGrid_CellValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellValidatingEventArgs) Handles DataGrid.CellValidating
        ...
        If row.Cells(e.ColumnIndex).IsInEditMode Then
            ...
            If e.ColumnIndex = 5 Then
                If Not chkGrdCellValue(row.Cells("yaf_fmlopt"), "String", 50) Then
                    e.Cancel = True
                End If
            End If
        End If
    ...
    Private Sub check_enq_right()
        If Enq_right_local = False Then
            'cmdInsRow.Enabled = False
            'cmdDelRow.Enabled = False
            mmdInsRow.Enabled = False
            mmdDelRow.Enabled = False
            Txtlnedsc.ReadOnly = True
            cboPcFac.Enabled = False
            cboDesign.Enabled = False
