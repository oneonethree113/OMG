...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SYM00033))
        ...
        Me.dgCharge.Location = New System.Drawing.Point(7, 27)
        Me.dgCharge.Name = "dgCharge"
        Me.dgCharge.RowHeadersWidth = 30
        Me.dgCharge.RowTemplate.Height = 24
        Me.dgCharge.Size = New System.Drawing.Size(942, 577)
        Me.dgCharge.TabIndex = 15
        '
        'StatusBar
        '
        Me.StatusBar.Font = New System.Drawing.Font("·s²Ó©úÅé", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(136, Byte))
        ...
        Me.Name = "SYM00033"
        Me.Text = "SYM00033 - Shipping Charges Formula Setup (SYM33)"
...
#End Region
    ...
    Private Sub SYM00033_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim dv As DataView = rs_SYMSHC.Tables("RESULT").DefaultView
        If Not dv.Count = 0 Then
            dv.Sort = "ysc_upddat desc"
            Dim drv As DataRowView = dv(0)
            Me.StatusBar.Items("lblRight").Text = Format(drv.Item("ysc_credat"), "MM/dd/yyyy") & " " & Format(drv.Item("ysc_upddat"), "MM/dd/yyyy") & " " & drv.Item("ysc_updusr")
