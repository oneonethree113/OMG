Public Class SHR00010
    ...
    Public rs_SHR00010_sub As New DataSet

    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        gspStr = "sp_select_SHR00010_new '','" & Me.txtdocno.Text & "'"
        '        gspStr = "sp_select_SHR00010_new '','" & Me.txtdocno.Text & "', 'E'"
        ...
        gspStr = " sp_select_SHR00010_sub '','" & Me.txtdocno.Text & "'"

        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        rtnLong = execute_SQLStatement(gspStr, rs_SHR00010_sub, rtnStr)
        ...
        'If cmbImageOnly.selectedIndex = 0 Then
        ...
        objRpt.Subreports.Item("sub").SetDataSource(rs_SHR00010_sub.Tables("RESULT"))
