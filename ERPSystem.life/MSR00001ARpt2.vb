...
Public Class MSR00001ARpt2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.MSR00001ARpt2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMSR00001ARpt2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MSR00001ARpt2 = New MSR00001ARpt2
        rpt.Site = Me.Site
        Return rpt
    End Function
