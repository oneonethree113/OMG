Public Class MSR00031


    Public rs_CUBASINF As DataSet
    Public rs_MSR00031 As DataSet
    ...
    Private Sub cmdShow_Click()
        ...
        If txtDateFrom.Text = "  /  /    " And txtDateTo.Text <> "  /  /    " Then
            MsgBox(" Invoice Date Empty (From) !")
            Exit Sub
        End If


        If txtDateFrom.Text <> "  /  /    " And txtDateTo.Text = "  /  /    " Then
            MsgBox("Invoice Date Empty (To) !")
            Exit Sub
        End If

        If Not IsDate(txtDateFrom.Text) Then
            MsgBox(" Invoice Date Invalid (From) !")
            Exit Sub
        End If

        If Not IsDate(txtDateTo.Text) Then
            MsgBox(" Invoice Date Invalid (To) !")
            Exit Sub
        End If

        If txtDateFrom.Text <> "  /  /    " Then
            'If CheckDate(txtDateFrom.Text) = False Then
            '    MsgBox("Invoice Date invalid !")
        ...
        ' Set Invoice Date value to empty then there is "  /  /    "
        Dim IDF As String
        Dim IDT As String
        ...
        '    If rs_MSR00031.Tables("RESULT").Rows.Count = 0 Then
        '        Me.Cursor = Windows.Forms.Cursors.Default
        '        '                msg("M00071")
        '        Exit Sub
        '    Else
        ...
        '        '************Sorting***********************
        '        If OptCust.Checked = True Then
        '            rs_MSR00031.Tables("RESULT").DefaultView.Sort = "Pri_Cust,Sec_Cust"
        '        Else
        '            rs_MSR00031.Tables("RESULT").DefaultView.Sort = "sih_invno"
        '        End If


        '        If (cboVenCdeFm.Text = "" And cboVenCdeTo.Text = "" And cboVenTypFm.Text = "" And cboVenTypTo.Text = "") Then
        '            '''ReportName(0) = "MSR00031.rpt"
        '        Else
        '            '''ReportName(0) = "MSR00031B.rpt"
        '        End If


        '        '''ReportRS(0) = rs_MSR00031
        '        frmReport.Show()
    ...
    Private Sub Form_Load()
        ...
        cboSIStatus.Items.Add("HLD - Hold")
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        Dim sort As String
        If cboSortBy.SelectedIndex = 0 Then
            sort = "Invoice"
        Else
            sort = "Customer No"
        End If
        ...
        'gspStr = "sp_select_MSR00031 '" & cboCoCde.Text & _
        '    "','" & CNF & "','" & cnt & _
        '    "','" & txtSIFm.Text & "','" & txtSITo.Text & _
        '    "','" & VENCDEFM & "','" & VENCDETO & _
        '    "','" & VenSubCdeFm & "','" & VenSubCdeTo & _
        ...
        'gspStr = "sp_select_MSR00031 'UCP','50000','59999','','','','','','','','','03/01/2009','03/01/2013','ALL','','mis'"

        gspStr = "temp_sp_select_MSR00031 '" & cboCoCde.Text & _
   "','" & CNF & "','" & cnt & _
              "','" & VENCDEFM & _
     "','" & VENCDETO & _
     "','" & VenSubCdeFm & _
     ...
     "','" & gsUsrID & "'"
        ...
        Me.Cursor = Windows.Forms.Cursors.WaitCursor
        rtnLong = execute_SQLStatement(gspStr, rs_MSR00031, rtnStr)

        If rtnLong <> RC_SUCCESS Then
            MsgBox("Error on loading MSR00031 : " & rtnStr)
            Exit Sub
        End If
        ...
        Else
            ...
            ' ''    rs_MSR00031.sort = "Pri_Cust,Sec_Cust"
            ' ''Else
            ' ''    rs_MSR00031.sort = "sih_invno"
            ' ''End If
            ...
            If cboSortBy.SelectedIndex = 1 Then
                rs_MSR00031.Tables("RESULT").DefaultView.Sort = "hih_cus1no, hih_cus2no, hid_invno"
            Else
                rs_MSR00031.Tables("RESULT").DefaultView.Sort = "hid_invno,hih_cus1no, hih_cus2no"
            End If


            Dim objRpt As New MSR00031Rpt
            objRpt.SetDataSource(rs_MSR00031.Tables("RESULT").DefaultView)
    ...
    Private Sub MSR00031_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cboSortBy.Items.Add("Invoice")
        cboSortBy.Items.Add("Customer No")
    ...
    Private Sub cboSIStatus_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboSIStatus.SelectedIndexChanged
