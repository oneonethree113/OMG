...
Public Class SCR00001RptHH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.SCR00001RptHH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSCR00001RptHH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SCR00001RptHH = New SCR00001RptHH
        rpt.Site = Me.Site
        Return rpt
    End Function
