...
Public Class SAM00001
    ...
    Private Sub Display_Header()
        ...
        lblRight.Text = Format(dr.Item("srh_credat"), "MM/dd/yyyy") & " " & Format(dr.Item("srh_upddat"), "MM/dd/yyyy") & _
        " " & dr.Item("srh_updusr")
    End Sub
    ...
    Private Sub Display_Summary()
        ...
        With grdSummary
            ...
            .Columns(7).HeaderCell.Value = "Customer Item"
            ...
            .Columns(10).HeaderCell.Value = "Color Code"
            ...
            .Columns(12).HeaderCell.Value = "Customer Color"
            ...
            .Columns(14).HeaderCell.Value = "UM"
            ...
            .Columns(19).HeaderCell.Value = "Sample UM"
            ...
            .Columns(22).HeaderCell.Value = "Fty CCY"
            .Columns(22).Visible = bolShow
            .Columns(22).Width = IIf(bolShow = True, 40, 0)

            .Columns(23).HeaderCell.Value = "Packing UM"
            .Columns(23).Visible = bolShow
            .Columns(23).Width = IIf(bolShow = True, 50, 0)


            .Columns(24).HeaderCell.Value = "Fty Prc"
            ...
            .Columns(25).HeaderCell.Value = "Fty Cst"
            ...
            If VendorType = "I" Then
                .Columns(26).HeaderCell.Value = "Item Sample Price"
            Else
                .Columns(26).HeaderCell.Value = "Fty Sample Price"
            End If
            ...
            .Columns(35).HeaderCell.Value = "Quotation No."
            .Columns(35).Visible = True


            .Columns(36).HeaderCell.Value = "PV"
            .Columns(36).Visible = True
            .Columns(36).Width = 150
            ...
            .Columns(38).HeaderCell.Value = "Pri Cust. No."
            .Columns(38).Visible = True
            .Columns(38).Width = 80


            .Columns(39).HeaderCell.Value = "Sec Cust. No."
            .Columns(39).Visible = True
            .Columns(39).Width = 80


            .Columns(40).HeaderCell.Value = "Fty Term"
            .Columns(40).Visible = True
            .Columns(40).Width = 80


            .Columns(41).HeaderCell.Value = "HK Term"
            .Columns(41).Visible = True
            .Columns(41).Width = 80


            .Columns(42).HeaderCell.Value = "Trans Term"
            .Columns(42).Visible = True
            .Columns(42).Width = 80


            .Columns(43).HeaderCell.Value = "Eff Date"
            .Columns(43).Visible = True
            .Columns(43).Width = 80


            .Columns(44).HeaderCell.Value = "Exp Date"
            .Columns(44).Visible = True
            .Columns(44).Width = 80
            .Columns(44).DefaultCellStyle.Format = "MM/dd/yyyy"
    ...
    Private Sub SetStatus(ByVal Mode As String)
        ...
        If Mode = "Init" Then
            ...
            If gsCompany = "UCPP" Then
                If VendorType = "I" Then
                    lblSmpFtyPrc.Text = "Item Sample Price "
                    If gsFlgCst = 1 Then
    ...
    Private Sub mmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mmdPrint.Click
        ...
        If Recordstatus = True Then
            MessageBox.Show("Sample Request has been changed. Please save before print.")
        Else
            Dim SAR00006 As New SAR00006
            SAR00006.callBySAM01(txtReqNo.Text, cboCoCde.Text)
    ...
    Private Sub txtVenCol_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtVenCol.TextChanged
        Recordstatus = True
    End Sub
    ...
    Private Sub SummaryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SummaryToolStripMenuItem.Click
        ...
        If TabPageMain.SelectedIndex <> 1 And TabPageMain.SelectedIndex <> 2 Then
            MessageBox.Show("Warning: This message box should not be displayed! " & _
                            "Check Summary Function can only be used in 'Detail' or 'Summary' tabpage. ")
        Else
            Dim SAM00002 As New SAM00002

            Dim itmno As String, cus1no As String, vendor As String
            Dim itmnoOpt As Boolean = True

            Dim dr As DataRow = rs_SAREQHDR.Tables("RESULT").Rows(0)
            dr.Item("cbi_cus1na").ToString()
            If txtCus1No.Text <> "" Then
                cus1no = txtCus1No.Text.Substring(0, txtCus1No.Text.IndexOf("-") - 1)
            End If
            Dim vnItm As Boolean = False

            If rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmno").ToString <> "" Then
                itmno = rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmno").ToString
            ElseIf rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmnotmp").ToString <> "" Then
                itmno = rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmnotmp").ToString
            ElseIf rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmnoven").ToString <> "" Then
                itmno = rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmnoven").ToString
                vendor = rs_SAREQDTL.Tables("RESULT").Rows(Current_Row).Item("srd_itmnovenno").ToString()
                vnItm = True
            Else
                MessageBox.Show("The Request Detail has no Item No. Cannot search summary. (The record of request may be corrupted.)")
                Exit Sub
            End If

            SAM00002.callBySAM01(cus1no, itmno, cboCoCde.Text, vnItm, vendor)
