...
Public Class PKR00001Rpt_ftr2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERPSystem.PKR00001Rpt_ftr2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPKR00001Rpt_ftr2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PKR00001Rpt_ftr2 = New PKR00001Rpt_ftr2
        rpt.Site = Me.Site
        Return rpt
    End Function
