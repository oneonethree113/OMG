...
Public Class INR00001
    ...
    Public rs_INR00001M As DataSet
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        Dim printCRD As String
        Dim printRTL As String
        Dim printCOO As String
        Dim printFRM As String
        Dim optblank As String
        Dim optAssor As String
        ...
        If optRtlY.Checked = True Then
            printRTL = "Y"
        Else
            printRTL = "N"
        End If

        If optCOOY.Checked = True Then
            printCOO = "Y"
        Else
            printCOO = "N"
        End If

        If optFRMY.Checked = True Then
            printFRM = "Y"
        Else
            printFRM = "N"
        End If

        If optblankY.Checked = True Then
            optblank = "Y"
        Else
            optblank = "N"
        End If
        ...
        'If optAssorY.Checked = True Then
        '    optAssor = "Y"
        'Else
        '    optAssor = "N"
        'End If
        ...
        If cboRptFmt.SelectedIndex = 0 Then
            ...
            gspStr = "sp_select_INR00001_NET '" & _
                        ...
                        printGroup & "','" & PrintAlias & "','" & printAss & "','" & _
                        printCRD & "','" & _
                        printRTL & "','" & _
                        printCOO & "','" & _
                        printFRM & "','" & _
            ...
            Dim objRpt As New INR00001Rpt_ftr2

            'objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))


            'objRpt.Database.Tables("INR00001").SetDataSource(rs_INR00001.Tables("RESULT"))
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 1 Then
            ...
            Else
                ...
                Dim objRpt
                '    If optAssor = "N" Then
                'If rs_INR00001B_ASSORT.Tables("RESULT").Rows.Count < 12 Then
                objRpt = New INR00001B1Rpt
                ...
                ' Else
                'objRpt = New INR00001B1Rpt_Ass_test_test
                'objRpt.Database.Tables("INR00001B").SetDataSource(rs_INR00001B.Tables("RESULT"))
                'objRpt.Database.Tables("INR00001B_ASSORT").SetDataSource(rs_INR00001B_ASSORT.Tables("RESULT"))
                'objRpt.Database.Tables("INR00001B_CPTBKD").SetDataSource(rs_INR00001B_CPTBKD.Tables("RESULT"))
                ''    End If
        ...
        ElseIf cboRptFmt.SelectedIndex = 2 Then
            ...
            Else
                ...
                '                If optAssor = "N" Then
                'If rs_INR00001B_ASSORT.Tables("RESULT").Rows.Count < 12 Then
                objRpt = New INR00001B2Rpt
                objRpt.Database.Tables("INR00001B").SetDataSource(rs_INR00001B.Tables("RESULT"))
                objRpt.Database.Tables("INR00001B_ASSORT").SetDataSource(rs_INR00001B_ASSORT.Tables("RESULT"))
                objRpt.Database.Tables("INR00001B_CPTBKD").SetDataSource(rs_INR00001B_CPTBKD.Tables("RESULT"))
                'Else
                'objRpt = New INR00001B2Rpt_Ass
                'objRpt.Database.Tables("INR00001B").SetDataSource(rs_INR00001B.Tables("RESULT"))
                'objRpt.Database.Tables("INR00001B_ASSORT").SetDataSource(rs_INR00001B_ASSORT.Tables("RESULT"))
                'objRpt.Database.Tables("INR00001B_CPTBKD").SetDataSource(rs_INR00001B_CPTBKD.Tables("RESULT"))
                '            End If
        ...
        ElseIf cboRptFmt.SelectedIndex = 8 Then
            ...
            Dim objRpt As New INR00001CRpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 10 Then
            ...
            Dim objRpt As New INR00001FRpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 9 Then
            ...
            Dim objRpt As New INR00001ERpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 6 Then
            ...
            Dim objRpt As New INR00001DRpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 4 Then
            ...
            Me.Cursor = Windows.Forms.Cursors.WaitCursor
            rtnLong = execute_SQLStatement(gspStr, rs_INR00001M, rtnStr)

            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading INR00001_NET : " & rtnStr)
                Exit Sub
            End If
            ...
            Dim objRpt As New INR00001GRpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))

            objRpt.Subreports.Item("manu").SetDataSource(rs_INR00001M.Tables("RESULT"))
            'objRpt.Subreports.Item("sub1").SetDataSource(rs_INR00001SUB.Tables("RESULT"))
            'objRpt.Subreports.Item("sub2").SetDataSource(rs_INR00001SUB.Tables("RESULT"))
            'objRpt.Subreports.Item("INR00001DP.rpt").SetDataSource(rs_INR00001DP.Tables("RESULT"))
            '      objRpt.Subreports.Item("subdetail").SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 7 Then
            ...
            Dim objRpt As New INR00001HRpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 11 Then
            ...
            Dim objRpt As New INR00001CIpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
        ...
        ElseIf cboRptFmt.SelectedIndex = 12 Then
            'New format - CB USA
            Me.optItm.Checked = False
            ...
            Dim objRpt As New INR00001CUpt
            objRpt.SetDataSource(rs_INR00001.Tables("RESULT"))
    ...
    Private Sub INR00001_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Mid(gsUsrGrp, 1, 3) = "ACT" Then
            cboRptFmt.Items.Add("Invoice Standard Format")
        Else
            ''' MichaelChiu corrected 20170321
            cboRptFmt.Items.Add("Invoice Standard Format")
            ...
            cboRptFmt.Items.Add("Invoice (PB Air Shipment Format USA)")
            cboRptFmt.Items.Add("Invoice (PB Air Shipment Format Australia)")
            cboRptFmt.Items.Add("Invoice (PB  Middle East Format)")
            cboRptFmt.Items.Add("Invoice (Ballard Format)")
            cboRptFmt.Items.Add("Invoice (Belk Format)")
            cboRptFmt.Items.Add("Invoice (Sams Mexico Format)")
            cboRptFmt.Items.Add("Invoice (TJX  Format)")
            cboRptFmt.Items.Add("Invoice (CB INTL Format)")
            cboRptFmt.Items.Add("Invoice (CB USA Format)")
    ...
    Private Sub optCOOY_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optCOOY.CheckedChanged

    End Sub

    Private Sub grpSearch_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub optblankY_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optblankY.CheckedChanged
