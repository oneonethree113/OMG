...
Public Class TOM00005
    ...
    Private Sub cmdShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShow.Click
        ...
        Else
            ...
            If opt_hk.Checked = True Then
                Call exportExcel_TOExportToExcelVendorType_hk()
            ElseIf opt_fty.Checked = True Then
                Call exportExcel_TOExportToExcelVendorType_fty()
            End If
    ...
    Private Sub exportExcel_TOExportToExcel()
        ...
        xlsWB = xlsApp.Workbooks.Open(Application.StartupPath + "\TOtemplate\TO TEMP(xls)3_fty.xls")
    ...
    Private Sub exportExcel_TOExportToExcelVendorType_ext_1756()
        ...
        Try
            ...
            'Copy  Data
            Dim dr_TOExcel() As DataRow = rs_TOExcel.Tables("RESULT").Select("tod_prdven ='1756' ")
    ...
    Private Sub exportExcel_TOExportToExcelVendorType_hk()
        ...
        Try
            ...
            If chk_int.Checked = True And chk_ext.Checked = False And chk_1756.Checked = False Then
                'int
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("((tod_prdven >='A' and tod_prdven <='Z' )  or (tod_prdven >='a' and tod_prdven <='z' ))")
            ElseIf chk_int.Checked = False And chk_ext.Checked = True And chk_1756.Checked = False Then
                'ext
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("not ((tod_prdven >='A' and tod_prdven <='Z' )  or (tod_prdven >='a' and tod_prdven <='z' ) or  tod_prdven like '%1756%' )")
            ElseIf chk_int.Checked = False And chk_ext.Checked = False And chk_1756.Checked = True Then
                '1756
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("tod_prdven like '%1756%'")
            ElseIf chk_int.Checked = True And chk_ext.Checked = True And chk_1756.Checked = False Then
                'int & ext=not 1756
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("not tod_prdven like '%1756%' ")
            ElseIf chk_int.Checked = True And chk_ext.Checked = False And chk_1756.Checked = True Then
                'int & 1756 = not ext
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("(tod_prdven >='A' and tod_prdven <='Z' )  or (tod_prdven >='a' and tod_prdven <='z' ) or  tod_prdven like '%1756%'  ")
            ElseIf chk_int.Checked = False And chk_ext.Checked = True And chk_1756.Checked = True Then
                'ext&1756 = not int
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("not ((tod_prdven >='A' and tod_prdven <='Z' )  or (tod_prdven >='a' and tod_prdven <='z' ))")
            ElseIf chk_int.Checked = True And chk_ext.Checked = True And chk_1756.Checked = True Then
                'all
                dr_TOExcel = rs_TOExcel.Tables("RESULT").Select("tod_prdven <> '$^&$%'")
        ...
        Try
            ...
            If saveto_folder.Text.Trim = "" Then
                '    xlsWB.SaveAs(Filename:="C:\" + txtFromQuotNo.Text + "_hk", FileFormat:=52)
                xlsWB.SaveAs(Filename:="C:\" + txtFromQuotNo.Text + "_hk", FileFormat:=52)
            Else
                '                xlsWB.SaveAs(Filename:="C:\" + saveto_folder.Text.Trim + "\" + txtFromQuotNo.Text + "_hk", FileFormat:=52)
                xlsWB.SaveAs(Filename:="C:\" + saveto_folder.Text.Trim + "\" + txtFromQuotNo.Text + "_hk", FileFormat:=52)
            End If
        ...
        Catch ex As Exception
            '            MsgBox("File " + "" + txtFromQuotNo.Text + "_hk" + ".xls already exist. Please delete it before export a new one.")
        End Try
    ...
    Private Sub exportExcel_TOExportToExcelVendorType_fty()
        Dim xlsApp As New Excel.ApplicationClass
        Dim xlsWB As Excel.Workbook = Nothing
        Dim xlsWS As Excel.Worksheet = Nothing
        Dim Message As String
        ...
        Try
            ...
            If saveto_folder.Text.Trim = "" Then
                '    xlsWB.SaveAs(Filename:="C:\" + txtFromQuotNo.Text + "_fty", FileFormat:=52)
                xlsWB.SaveAs(Filename:="C:\" + txtFromQuotNo.Text + "_fty", FileFormat:=52)
            Else
                '                xlsWB.SaveAs(Filename:="C:\" + saveto_folder.Text.Trim + "\" + txtFromQuotNo.Text + "_fty", FileFormat:=52)
                xlsWB.SaveAs(Filename:="C:\" + saveto_folder.Text.Trim + "\" + txtFromQuotNo.Text + "_fty", FileFormat:=52)
            End If
        ...
        Catch ex As Exception
            'MsgBox("File " + "" + txtFromQuotNo.Text + "_fty" + ".xls already exist. Please delete it before export a new one.")
        End Try
    ...
    Public Sub callByTOM01(ByVal TOreqno As String, ByVal ComparyCode As String)
        TOno = TOreqno
        CoCde = ComparyCode
        'Hints: In .net, 'Shown' event is called after 'Load' event
        AddHandler Me.Shown, AddressOf callByTOM01AfterLoading
        Me.ShowDialog()

    End Sub

    Private Sub callByTOM01AfterLoading()


        txtFromQuotNo.Text = TOno
        txtFromQuotNo.Enabled = False

        cboCoCde.SelectedItem = CoCde
        cboCoCde.Enabled = False
        RemoveHandler Me.Shown, AddressOf callByTOM01AfterLoading
    End Sub
