Public Class SYM00026
    ...
    Private Sub SYM00026_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If rtnLong <> RC_SUCCESS Then
                MsgBox("Error on loading SYM00026 sp_select_SYCUREX : " & rtnStr)
            Else
        ...
        If flgMod Then
            ...
            If YNC = Windows.Forms.DialogResult.Yes Then
                If Enq_right_local Then
                    ...
                    If save_ok Then
                        Call SYM00026_Load(Nothing, Nothing)
                    Else
                        Exit Sub
                    End If
                Else
            ...
            Else
                ...
                For Each dr As DataRow In rs_curex.Tables("RESULT").Rows
                    ...
                    If gspStr <> "" Then
                        ...
                        If rtnLong <> RC_SUCCESS Then
                            MsgBox("Error on loading SYM00026 sp_update_SYCUREX : " & rtnStr)
                            flgErr = True
                            Exit For
                        End If
                        gspStr = ""
    ...
    Private Sub SYM00026_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim YNC As Integer
        Dim flgMod As Boolean = False
