Public Class frmImgPrevw
    ...
    Private Sub frmImgPrevw_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        'pBoxImage.Load(gs_PDO_SMImg & myOwner.lstShipMark.SelectedItem.ToString)
        pBoxImage.Load(imgPath)
    ...
    Public Sub setImagePath(ByVal path As String)
        If IO.File.Exists(path) = True Then
            imgPath = path
        Else
            MsgBox("Image Path does not exist: " & path)
        End If
    End Sub
