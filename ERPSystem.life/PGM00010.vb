...
Public Class PGM00010
    ...
    Public Sub show_frmPGM00010(ByVal frm As Form)
        frmS = frm
        Me.ShowDialog()
    End Sub
    ...
    Private Sub fillCus1No()
        ...
        If add_flag = True Then
            ...
            Dim drCUBASINF_P() As DataRow = rs_CUBASINF_P.Tables("RESULT").Select("cbi_cusno >= '50000'", "cbi_cussna")
